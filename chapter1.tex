...
The Gospels known to us today are only first implied to exist when Irenaeus, writing in the late second century, describes Marcion's activity around 140 CE \cite[3.11.7]{irenaeus:advhaer}.
...
Irenaeus, who elsewhere makes bold and confident assertions, is notably more reserved when assigning Gospel authorship \cite[3.1.1]{irenaeus:advhaer}.
