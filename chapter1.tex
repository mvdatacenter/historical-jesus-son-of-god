...
Scholars have devoted entire books and articles to the argument that the authors of the Gospels and Acts borrowed from Eastern Mediterranean texts \cite{macdonald:homeric-mark,macdonald:nt-homer,moles:jesus-dionysus}.
Their case rests not on isolated similarities, but on extended sequences joined by unusual details that often fit poorly within the biblical narrative itself \cite{macdonald:homeric-mark,macdonald:nt-homer,moles:jesus-dionysus}.
A catalogue of manuscripts from Greco-Roman Egypt lists more than six hundred for Homer and seventy-seven for Euripides, compared with eighty-three for Demosthenes and seventy-two for Hesiod \cite[3]{macdonald:nt-homer}.
In Mark 4:35--5:20, Jesus crosses the sea, meets an uncontrollable man living among the tombs, asks his name, receives ``Legion, for we are many,'' sends the demons into swine, and leaves again by sea.
...
In Acts 16:25--28, Paul and Silas sing in prison before an earthquake opens the doors and releases their bonds; the jailer draws his sword, but the prisoners do not escape.
...
John 11:39--44 has Jesus stand before a tomb closed by a stone, call Lazarus by name, and command that the dead man, still bound in grave cloths, be unbound.
...
These are selected examples from larger documented arguments; their full cases cannot be reproduced in an introduction.
The criteria used to argue for Homeric mimesis remain disputed \cite{sandnes:imitatio-homeri}.
A voyage is entirely plausible within a story about Jesus and can still establish the order of the comparison.
The harder question is why Mark places, in that sequence, four more unusual details: an uncontrollable man among tombs, a question about his name, the answer ``Legion, for we are many,'' and the transfer of the demons into swine \cite[63--74, 175--176]{macdonald:homeric-mark}.
