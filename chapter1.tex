...
While many critics claim the parallels are forced and not genuine, we argue that many are very much valid and real.
...
The most fundamental issue of this theory is that there are events in the new testament where the author mentions a critical detail that is almost inconceivable to have been fabricated if there was not a kernel of historical truth.
...
We will explain the significance why these details are so important in later chapters.
On top of that, it is very hard to explain the sheer number of authors who seem to selectively know the geography, language, of the events they are alleged to be a part of.
It is hard to imagine the myth that would have been so precisely coordinated across so many authors and communities.
