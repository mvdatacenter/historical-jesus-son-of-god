...
Two examples from a broader catalogue of ordered clusters support deliberate literary mimesis: Mark 5 combines \emph{Odyssey} 9's sea crossing, cave-dwelling opponent, ``Nobody'' exchange, and sheep with book 10's swine, changing ``Nobody'' to ``Legion'' \cite[63--74, 175--176]{macdonald:homeric-mark}; Acts 16:25--28 follows \emph{Bacchae} 576--659 through hymns in confinement, earthquake, fallen bonds, drawn sword, and prisoners who refuse to flee \cite{moles:jesus-dionysus}.
