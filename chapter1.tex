...
It began in the Enlightenment, flourished in the nineteenth century with many “Lives of Jesus” \cite{schweitzer:quest}, was cut back by early twentieth-century skepticism, and has been renewed since the mid-century in successive waves.
...
The rhetoric is urgent---watchfulness, division, harvest, reckoning---and the frame is the same one found in Daniel (Dan 7:9--14), 1 Enoch (1 En 1:3--9), 4 Ezra (4 Ezra 7:26--44), and the Dead Sea Scrolls (1QM 1; 4Q521 2 ii): God judges the wicked, vindicates the righteous, restores Israel, and reorders the world.

Advocates point to a cluster of sayings that read naturally in this horizon.
Jesus speaks of the “Son of Man” (ὁ υἱὸς τοῦ ἀνθρώπου) who will be revealed, of cosmic portents, and of nearness indexed to “this generation” (ἡ γενεὰ αὕτη; Mark 13:24--27, 30).
...
Even Jesus’ reply to John the Baptist---“the blind see, the lame walk, the poor have good news preached to them”---echoes an eschatological sign list (cf. Isa 35:5--6; 61:1; 4Q521 2 ii 12; Matt 11:5; Luke 7:22), tying healings to end-time renewal rather than mere compassion.
...
It explains the urgency of Jesus’ summons, why his movement could be read as destabilizing by both priestly elites and Rome, why kingship language sounded political, and why crucifixion---the Roman penalty for seditious claimants, the sentence the third-century jurists prescribe for authors of sedition \cite[5.22.1]{paulus:sententiae} and the one Felix applied wholesale to Judean brigands in the 50s AD \cite[2.253]{josephus:war}---became the end of his public course.
It also explains why the earliest preaching carries eschatological pressure forward: Paul’s letters, for example, register both the nearness of the end and the need to order communities under that expectation (1 Thess 4:13--5:11; 1 Cor 7:29--31).

The tensions are real.
Timelines are hard: sayings about “some standing here” who will see the kingdom (Mark 9:1), or about events arriving before a generation passes (Mark 13:30), sit uneasily with delay.
...
If Jesus was simply one among many Jewish apocalyptic preachers, his message proved strikingly unconvincing in its own homeland: within a generation the majority of Jews rejected it, as Paul himself concedes (Rom 9:1--5; 11:7--10) and as Acts stages in its closing scene (Acts 28:24--28), and the movement held only a marginal foothold in Judea.
Yet the same message proved astonishingly persuasive among Greeks, spreading across cities and cultures at a pace no other apocalyptic sect achieved; by 112 AD a governor of Bithynia reports it in towns, villages, and countryside among every age and rank \cite[10.96]{pliny:letters}.
...
Galatians, whose own chronology places it some seventeen years after Paul's call and so among the earliest texts in the New Testament (Gal 1:18; 2:1), centers on justification by faith, life in the Spirit, unity, and love, with apocalyptic expectation serving only as a backdrop.
Similarly, the core teachings that are most widely confirmed for historical Jesus, the Lord's Prayer (Matt 6:9--13; Luke 11:2--4), the Sermon on the Mount (Matt 5--7; Luke 6:20--49), and the parables of mercy (Luke 15), also treat end times as a backdrop rather than the core message.
...
The fullest statement of this thesis argued that Jesus stood in continuity with the nationalist zealot tradition, that the Temple action was a revolutionary sign-act, and that his disciples were not merely hearers but comrades in resistance \cite{brandon:zealots,brandon:fall}.
Unlike later proposals that equate Jesus with specific rebel leaders, this version did not depend on collapsing him into Judas or the Egyptian, but rather saw him as a distinct figure shaped by the same revolutionary currents.
...
One proposal equates him with "the Egyptian" mentioned by Josephus \cite[20.169--172]{josephus:ant}, a prophet who led thousands to the Mount of Olives in the 50s CE and promised to bring down Jerusalem's walls.
...
The difficulty is chronological, since Josephus places the Egyptian two decades too late \cite[2.261--263]{josephus:war}.

Another variant links Jesus with Judas the Galilean, who led a revolt against Rome at the time of Quirinius' census in 6 CE \cite[18.1--10]{josephus:ant} and is remembered as the founder of the zealot movement.
...
The first explicit defense of four---and only four---canonical Gospels appears in Irenaeus, writing in the late second century, who assumes their authority as established fact and notes that Marcion used only a mutilated version of Luke \cite[3.11.7]{irenaeus:advhaer}.
While they are frequently dated to the late first century, the mythicist case presses the evidence for mid second century dates.
...
Irenaeus assigns Gospel authorship with confidence, naming each evangelist and the circumstances of their writing \cite[3.1.1]{irenaeus:advhaer}.
...
On this reading the Gospels do not present independent eyewitness voices but rather a layered literary tradition: Mark written first, Matthew and Luke revising it, and John reshaping it theologically.
The texts themselves show signs of successive editing---Matthew and Luke revise Mark, John reworks the tradition independently---and our manuscripts are copies of copies, with much of the original content likely lost or reshaped.
...
Moses scores 20 out of 22 on the Rank--Raglan heroic pattern scale, a measure of how far a biography follows the traditional hero pattern, where Oedipus scores 21 and Theseus 20 \cite{raglan:hero}.
Historical rulers score far lower on this scale.
The "modern Moses" framing therefore rests on a narrative form already structured by the conventions of legendary heroic biography.

But the parallels extend well beyond scripture.
Jesus' healings, exorcisms, and life story have hundreds of uncanny parallels in the life of Apollonius of Tyana, among them a demon driven out of a youth at Athens, a plague-demon unmasked at Ephesus, a bride raised from her bier at Rome, a boy healed of a mad dog's bite, a vanishing from Domitian's court, and an appearance after death to a doubting disciple \cite[4.10, 4.20, 4.45, 6.43, 8.5, 8.30--31]{philostratus:apollonius}.
His wine miracle at Cana, the Eucharist, and resurrection recalls Dionysian cult.
Multiple sources document Dionysus performing water-into-wine miracles.
Theopompus (4th century BCE) reports that at the god's festival in Elis three empty cauldrons are sealed before witnesses and found full of wine \cite[1.34a--b]{athenaeus:deipnosophistae}, Diodorus that a fountain of sweet wine flows from the earth at fixed times in Teos \cite[3.66.2]{diodorus:library}, Pausanias the same Elean cauldrons and the Andrian claim that wine flows of its own accord from the sanctuary every other year \cite[6.26.1--2]{pausanias:description}, Pliny the spring in the temple of Father Liber on Andros running with wine on the god's feast \cite[2.231; 31.16]{pliny:nh}, and Plutarch a spring at Haliartus, where the nurses bathed the infant Dionysus, whose water has the colour and sparkle of wine \cite[Lysander 28.4]{plutarch:lives}.
Only the first two are pre-Christian; Plutarch and Pausanias write after the Gospels.
...
Scholars have devoted entire books and articles to the argument that the authors of the Gospels and Acts borrowed from Eastern Mediterranean literature \cite{macdonald:homeric-mark,macdonald:nt-homer,moles:jesus-dionysus}.
Their method compares extended sequences, giving the greatest weight to unusual details that sit awkwardly in the biblical episode yet appear in the same order elsewhere \cite{macdonald:homeric-mark,macdonald:nt-homer,moles:jesus-dionysus}.

In Mark 4:35--5:20, Jesus crosses the sea, meets an uncontrollable man living among the tombs, asks his name, receives the answer ``Legion, for we are many,'' sends the demons into swine, and leaves again by sea.
\emph{Odyssey} books 9 and 10 likewise move from a voyage to a violent cave-dweller, a question about a name answered with ``Nobody,'' an escape beneath the Cyclops's sheep, men transformed into swine, and another voyage \cite[9]{homer:odyssey}\cite[10]{homer:odyssey}\cite[63--74, 175--176]{macdonald:homeric-mark}.
The voyages establish the order of the comparison, while four less ordinary features carry the proposed connection: the violent isolated figure, the question about his name, the unexpected answer, and the swine episode \cite[63--74, 175--176]{macdonald:homeric-mark}.

Acts 16:25--28 presents Paul and Silas singing in prison before an earthquake opens the doors and releases their bonds; the jailer draws his sword, but the prisoners remain.
In \emph{Bacchae} 443--448 and 576--659, prison doors open and bonds fall without human hands; Dionysus calls from confinement and summons an earthquake; Pentheus draws his sword against a phantom of Dionysus; and Dionysus waits rather than escaping \cite[443--448]{euripides:bacchae}\cite[576--659]{euripides:bacchae}\cite{moles:jesus-dionysus}.
The proposed relationship thus rests on four events in the same order: supernatural release, an earthquake, a drawn sword, and the prisoner's refusal to flee \cite{moles:jesus-dionysus}.

John 11:39--44 places Jesus before a tomb closed by a stone, where he calls Lazarus by name and orders that the dead man, still bound in grave cloths, be unbound.
In the Setne Khamwas cycle, Naneferkaptah rises from his bier and speaks inside his tomb \cite[127--133]{lichtheim:ael3}.
Egyptian rites performed at the tomb to open the mouth were intended to restore breath, speech, and the senses to the dead \cite[310--329]{assmann:death-salvation}.
The comparison places John's stone-closed tomb, call to the dead, and unbinding command beside Egyptian stories and rites in which the dead rise, speak, and recover bodily powers \cite[127--133]{lichtheim:ael3}\cite[310--329]{assmann:death-salvation}.

These three clusters are selected from much larger cases \cite{macdonald:homeric-mark,macdonald:nt-homer,moles:jesus-dionysus}.
Scholars have not reached a common judgment on whether particular correspondences establish direct borrowing \cite{sandnes:imitatio-homeri}.

Literary construction is only one side of the mythicist case.
The other begins with Paul's letters, which, on this reading, describe no Galilean rabbi.
...
Josephus is dismissed as interpolated \cite[18.63--64]{josephus:ant}.
...
Plutarch states in his Life of Alexander that biography aims to reveal character rather than record every event with precision \cite[Alexander 1.2]{plutarch:lives}.
The Gospels follow the same Greco-Roman biographical practice, presenting meaning and identity through narrative construction.
Truth in this genre concerns who a person is and what his life signifies, not the stenographic preservation of detail.
Other critics point out the extreme precision of geographic and unrelated historical details in the texts.
...
For example John’s Gospel reports that Joseph of Arimathea and Nicodemus bring a mixture of myrrh and aloes to anoint Jesus’ body (John 19:39).
A late mythical John would not have produced medical agents while Jesus was buried in a hurry.
Or Matthew talking about the father who will reward you in secret (Matt 6:4, 6).
A late mythical Matthew would not have quoted overheard Egyptian theology in a Jewish prophetic context.
Or later texts naming the magi as Caspar, Melchior, and Balthazar \cite[86]{excerpta:barbari}.
...
We are quite certain that there were already major disagreements about Jesus’ identity and message within just years of his death (Gal 1:6--9; 2:11--14; 1 Cor 1:11--12).
...
The Gospels present this dimension not as ornament but as central: exorcisms of demons, cures of blindness and lameness, restorations of lepers, and actions that reintegrated the ritually impure (Mark 1:23--28, 40--45; 2:1--12; 5:1--20, 25--34; 10:46--52).
Such traditions are multiple, early, and widespread, and they align with Jewish memories of holy men like Honi the Circle Drawer (Josephus, \emph{Antiquities} 14.22; Mishnah \emph{Taanit} 3:8) and Hanina ben Dosa (Mishnah \emph{Berakhot} 5:5; Babylonian Talmud \emph{Berakhot} 33a), who were recalled for prayer, rainmaking, or healing.
...
Not surprisingly, an enormous number of books have been written that develop this portrait in different ways, sometimes emphasizing the Jewish holy man \cite{vermes:jesus}, sometimes focusing on social reintegration, sometimes on political economy, sometimes on religious experience, and sometimes on broader Mediterranean parallels.
...
Early letters like Paul’s, our first Christian texts, mention visions and spiritual gifts (1 Cor 12:9--10, 28; 2 Cor 12:1--4) but do not narrate Jesus as healer in detail, suggesting that miracle stories grew in prominence after his death.
...
\section{Sage and teacher.}\label{sec:teacher}
...
He debates halakhah with rigor while pressing mercy and the “weightier matters of the law” (Matt 23:23).
...
A body of modern scholarship develops this theme \cite{tabor:dynasty,eisenman:james,maccoby:revolution,thiering:jesusman,jacobovici:tomb,baigent:holyblood}.
...
The earliest evidence shows synagogues divided (Acts 13:44--50; 14:1--4; 17:1--5; 18:4--8), but within a generation Jewish adherence is marginal while Greek cities across the empire host flourishing assemblies.
...
Earliest worship treats him as κύριος and Son, not merely teacher (Phil 2:9--11; Rom 1:3--4).
Communities invoke his name in prayer, hymn, and meal as if divine presence is operative (1 Cor 16:22; Phil 2:6--11; 1 Cor 11:23--26).
...
Modern scholarship inherited from nineteenth-century German Romanticism and the Tübingen school the assumption of an original rural Jewish core to Christianity, with Greco-Roman elements treated as later additions \cite{schweitzer:quest}.
This framework isolates Jesus from the educated Hellenistic institutional world visible in the earliest texts.
The surveyed models all begin with a Jewish peasant figure and then explain Greek language and civic structure as secondary, even though the surviving evidence already speaks fluent Greek administrative and philosophical vocabulary.
...
The background that restores coherence is the Greek institutional world that shaped every political vocabulary, every civic structure, and every textual form in which the early Christian movement expressed itself.
The next chapter turns to that world---not as an optional influence, but as the governing framework without which the surviving sources cannot be read in their own historical context.
