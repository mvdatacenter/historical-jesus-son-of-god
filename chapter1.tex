...
Odysseus calls himself ``Nobody''; the demoniac calls himself ``Legion.''
Odysseus blinds the Cyclops and sails away after refusing the Cyclops's request to return; Jesus casts out the demons and sails away after refusing the demoniac's request to follow him.
In \emph{Odyssey} 10, Circe turns Odysseus's men into swine; in Mark, Jesus sends the demons into swine, which rush into the sea \cite[63--74, 175--176]{macdonald:homeric-mark}.
