...
A catalogue of manuscripts from Greco-Roman Egypt lists more than six hundred for Homer, compared with eighty-three for Demosthenes, seventy-seven for Euripides, and seventy-two for Hesiod \cite[3]{macdonald:nt-homer}.
...
In Mark 4:35--5:20 and \emph{Odyssey} 9, travelers cross the sea and meet a violent man: the Cyclops lives in a cave; the demoniac lives among tombs.
Odysseus calls himself ``Nobody'' in \emph{Odyssey} 9; the demoniac calls himself ``Legion'' in Mark 5:9.
In \emph{Odyssey} 9, Odysseus blinds the Cyclops, sails away, and refuses the Cyclops's request to return; in Mark 5:13--20, Jesus casts out the demons, sails away, and refuses the demoniac's request to follow him.
In \emph{Odyssey} 10, Circe turns Odysseus's men into swine; in Mark 5:13, Jesus sends the demons into swine, which rush into the sea \cite[63--74, 175--176]{macdonald:homeric-mark}.
In Acts 16:25--30, Paul and Silas sing in prison before an earthquake opens the doors, and the jailer rushes in with a sword to find the prisoners still there.
In \emph{Bacchae} 576--659, Dionysus's followers sing before an earthquake frees him; Pentheus rushes in with a sword, but Dionysus does not flee \cite{moles:jesus-dionysus}.
