...
The Gospels known to us today are only first implied to exist when Irenaeus describes Marcion's activity of 140CE .
While they are frequently dated to the late first century, the evidence for mid second century dates is strong too.
First century and early second century do not show any clear references the Gospels and epistles we know today and a direct mention would be expected if they existed.
Even by late first century most followers of Jesus were likely long dead or at least too old to be able to compose literary works.
The texts are anonymous, and were attributed to Matthew, Mark, Luke, and John only much later by the church fathers, and with a lot of overt speculation on their part.
Irenaeus in his work is not particularly reserved about making claims, but he does explain his logic in attributing the Gospel authorship, and he seems aware that some of it is an educated guess, not a well trusted sacred tradition passed down from the apostles.
