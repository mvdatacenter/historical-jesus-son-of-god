...
Her findings resulted in the construction of the Church of the Annunciation, the Church of St.~Joseph, and the Basilica of Jesus the Adolescent \cite[3.41--43]{eusebius:vita}.
...
Ancient historiography refrained from describing events that no eyewitness could verify, and this convention shapes the way Thucydides \cite{thucydides:peloponnesian}, Polybius, Tacitus, and Josephus narrate moments where testimony is absent.
...
Josephus records precisely such an intervention \cite[75]{josephus:life}, where elite Jews request the bodies of crucified men and secure their removal, and one of the victims survives after being taken down.
