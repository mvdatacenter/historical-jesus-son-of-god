...
And so we need to seriously reevaluate the assumption that Jesus and his apostles were illiterate peasants from a backwater village of the Roman empire.
Based on all evidence outlined above, it is very plausible that Jesus grew up in a much richer and more cosmopolitan environment than usually assumed.
Herod the Great rebuilt Sepphoris as a royal city, and a regional capital matching Jerusalem in rank.
We excavated, within presumably a walking distance from Jesus's home a Greek theater, a Roman-style forum, a herodian palace, colonnaded streets, and elite villas decorated with mosaics such as the famous Dionysus and Nile Festival scenes.
