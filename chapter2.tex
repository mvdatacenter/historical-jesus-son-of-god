...
The priests are said to approach Pilate the day after the burial to secure the tomb, and later to pay the guards to spread the explanation that the disciples stole the body while they slept.
Matthew then adds that this explanation “is told among the Jews to this day.”
The structure of this passage strongly suggests it is responding to an existing narrative.
The overall tone of the section is defensive—it reads exactly like an effort to answer known real events that were already being discussed openly.
If the existing narrative was so strong it required Matthew to address it so directly, there is a high likelihood it was simply the truth.
The preponderance of evidence suggests that Joseph of Arimathea was already planning to retrieve Jesus from the cross before death.
Matthew’s reference to a “large sum of money” reflects awareness of real financial dealings connected to that access.
