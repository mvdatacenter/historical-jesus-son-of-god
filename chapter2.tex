...
Around 10 CE, the fall of Strato II Soter, the last of the Indo-Greek kings in the Punjab, left Judea and its client dynasties among the final regions still governed under Hellenistic political traditions rather than direct Roman rule.
...
The lists of the women who travelled with Jesus and stood at the cross and the tomb make the point countable.
Across the four Gospels the other women are labelled by their men: Mary the mother of James the younger and of Joses (Mark 15:40, 47; 16:1; Matt 27:56; Luke 24:10), Mary the wife of Clopas (John 19:25), the mother of the sons of Zebedee (Matt 27:56), Joanna the wife of Chuza, Herod's steward (Luke 8:3), and the sister of Jesus's mother (John 19:25); Salome and Susanna get a bare name.
Mary Magdalene stands in every one of these lists (Mark 15:40, 47; 16:1; Matt 27:56, 61; 28:1; Luke 8:2; 24:10; John 19:25) and twice alone at the tomb (John 20:1, 18), eleven times under this label and never once as anyone's wife, mother, or daughter.
Her label is her own, and Luke gives it the form he uses for a by-name, ``Mary who is called Magdalene'' (Luke 8:2, ἡ καλουμένη Μαγδαληνή), the construction he uses for Simon ``who is called the Zealot'' (Luke 6:15) and Judas ``who is called Iscariot'' (Luke 22:3), whereas a man from a place is ``from'' it, as Joseph is ``from Arimathea, a city of the Jews'' (Luke 23:51; Mark 15:43).
Jerome read the epithet as a title: she ``received the name of the tower for her earnestness and the ardour of her faith'' (\emph{turritae nomen accepit}, Ep.~127.5) \cite{jerome:epistulae}.
The movement then had two title-bearing leaders, Simon whom Jesus named the Rock (John 1:42) and Mary the Tower, and the same Luke names her first among the women who ``provided for them out of their own resources'' (Luke 8:2--3), ahead of the wife of Herod's steward.
A name carried by a place or a title rather than by a father is, in the Greek world as later in the ``von,'' ``van,'' and ``de'' of the European nobility, the mark of a house that needs no father named; Jesus and Mary Magdalene, both so designated, stood in the same class, and she stood there on her own means.
...
Ancient sources record that when Antiochus IV mandated participation in Dionysiac festivals (2~Maccabees~6:7), segments of the Jewish population complied and the cult presence did not disappear after his death.
The Dionysus mosaics at Sepphoris reflect an environment in which Dionysian imagery retained religious meaning among local elites into the first century CE.
This is sustained syncretism within Palestinian Judaism, not decorative import detached from cultic life.
...
Hellenistic practice penetrated the Jerusalem priestly aristocracy itself.
In the Caiaphas family tomb, excavators found a Greek obol placed in the mouth of a deceased member, the payment for Charon's ferry in Greek funerary custom.
The household of the high priest who presided over Jesus' trial followed Greek burial rites.
...
Pharaohs were remembered as ``builders of temples''; Darius was described as ``the great builder of this empire''; Solomon was the builder of the Temple; Augustus famously boasted of transforming Rome from brick to marble; and Greek founders were called \emph{architektōn}---master-builders of their cities.
...
Armenian uses շինարար (\emph{shinārar}), Georgian uses მშენებელი (\emph{mshenebeli}), both explicitly meaning ``builder'' or ``constructor.''
Syriac and Ge'ez retain Semitic roots (\emph{naggara}, related to Hebrew \emph{naggar}) that denote craftsmanship without the specifically low-status connotations of medieval European guilds.
Western translations---English, German, Polish, Russian, Latin, French, Spanish---all adopted ``carpenter'' (\emph{Zimmermann}, \emph{cieśla}, \emph{плотник}, \emph{faber}, \emph{charpentier}, \emph{carpintero}).
...
The ecclesia had a fixed structure led by a \emph{prytanis} (presiding officer), with texts read aloud by a herald.
Assisting the prytanis was a \emph{diakonos}---a deacon---who served as ritual functionary and aide during the proceedings.
...
In fact, the Greek word διάκονος (\emph{diakonos}) and the office it described were already well-attested in Greek civic and temple contexts long before Jesus was born.
In temple settings, \emph{diakonoi} assisted priests during sacrifices, carried vessels and offerings, held incense, and signaled ritual transitions with bells or instruments.
...
It culminated in a communal meal of bread and wine, followed by announcements (\emph{kerygma}) at the very end.
...
The proceedings were interwoven with chants and songs from the entire congregation, led by a \emph{khersmodos} (choir leader) and a group of musicians who often played on a \emph{hydraulis} (water organ).
...
When he used the word \emph{ecclesia}, he meant that kind of public, visible, status-displaying community event---not a synagogue, not a prayer circle, not a sect meeting.
...
First, Jesus explicitly uses the word \emph{ecclesia} in a way that assumes his audience already understands what it means.
...
His disciples distribute bread and fish to the seated groups in an orderly, ritualized fashion, exactly as \emph{diakonoi} would distribute food in a communal meal following an ecclesia.
...
Jesus presides as \emph{prytanis}.
...
Jesus is training his disciples to preside over local assemblies---\emph{ecclesiae}---in his name.
...
The Greek word παραβολή (\emph{parabolē}) means ``comparison'' or ``illustrative story,'' and it was a standard rhetorical device used in Greek assemblies, courts, public festivals, and philosophical schools.
Speakers used \emph{parabolai} to make moral conclusions, deliver civic warnings, render political judgments, evaluate character, and make complex issues intuitive for the demos.
Demosthenes employed them in political speeches.
Aesop's fables---widely known throughout the Greek world---were \emph{parabolai} used to convey moral and political lessons.
...
It is the survival of the Greek practice of using \emph{parabolai} in the ecclesia to teach moral and political truths to the assembled citizens.
...
Mixing up the terms \emph{Christos} and \emph{Messiah} is deeply rooted in the historiography of Jesus.

The common narrative is to dismiss the idea of “Jesus, son of Mary and Joseph, Christ” as ridiculous, and then to say that \emph{Christos} was simply the Greek translation of the Jewish term \emph{Messiah}, and not a title in its own right.

Nearly every historical treatment of the topic forgets that \emph{Christos} is a Greek term meaning “anointed one,” often used for royal or chosen figures, while \emph{Messiah} is a Jewish term referring to a prophesied apocalyptic figure.
The New Testament overwhelmingly uses \emph{Christos}, whereas \emph{Messiah} appears only a few times, usually in dialogues with Jewish figures.
This suggests that the term \emph{Messiah} was employed only when convincing Jewish audiences that Jesus the \emph{Christos} was also their expected \emph{Messiah}.

In Greek usage, \emph{Christos} applied to athletes, rulers, and initiates --- categories tied to public honor and kingship, not to hidden Jewish prophecy.
If \emph{Christos} were simply a translation of \emph{Messiah}, we would expect to find the Greek term used in Jewish texts outside Christianity.
Yet apart from a rare usage in Aeschylus (\emph{Prometheus Bound}) \cite{aeschylus:prometheus}, its earliest sustained association is with Jesus.

And so we arrive at another strong argument: Jesus \emph{Christos} may well have been understood as a royal figure.
...
What exactly is a gospel or \emph{euangelion}?

In the wider Mediterranean, \emph{euangelion} was not originally a Christian word at all but a political one.
In the Greek cities it denoted the proclamation of royal victories or accessions.
Plutarch \cite[Sertorius 11.4]{plutarch:lives} uses the word for the "good news" brought from the battlefield, and papyri from Egypt (e.g. P.Oxy. 42.3010, AD 9) announce \emph{euangelion} when generals like Germanicus had triumphed.
...
At Priene (9 BC) the decree for Augustus (OGIS 458) calls his birthday “the beginning of the good news (\emph{euangelia}) for the world,” and a similar decree from Halicarnassus (2 BC) speaks of his honors as “good news to all the cities.”
Josephus \cite[4.618]{josephus:war} describes the rise of Vespasian as \emph{euangelia} proclaimed to the people, and Cassius Dio \cite[51.19.6]{cassiusdio:romanhistory} reports Actium's outcome in these terms.
By the first century, then, \emph{euangelion} had become the stock word for a ruler’s accession or military victory, whether in Greek or Roman settings.
...
Hasmonean coinage adopted Hellenistic astral symbolism as royal propaganda.
Coins of John Hyrcanus I marking independence from Antiochus VII display a five-pointed star, linking Balaam's prophecy of a star from Jacob (Numbers 24:17) with the nova observed by Hipparchus in the Greek world.
Jewish messianic expectation and Greek astronomical sign were joined on official state currency.
...
The oldest witnesses to Luke's baptism scene read, "You are my son; today I have begotten you" (Psalm 2:7), as preserved in Codex Bezae and Old Latin manuscripts, framing the baptism as a moment of royal begetting.
This is a coronation formula, and the genealogy follows because the new king has just been proclaimed.
John's Gospel adds that Jesus and John conducted parallel baptizing missions until Jesus surpassed John in followers (John 3:22--26; 4:1--3), a pattern that reads as succession of authority rather than private spirituality.
...
Eusebius records that Vespasian, after the fall of Jerusalem, ordered a search for all descendants of David (HE 3.12).
Domitian later summoned and interrogated the grandsons of Jude, brother of Jesus, specifically concerning their Davidic lineage (HE 3.19--20).
Under Trajan, Simeon son of Clopas was executed on the charge of being both a descendant of David and a leader among Christians (HE 3.32).
Three successive emperors treated the Davidic bloodline as a matter of state security.
This is sustained imperial surveillance of a royal house, not suppression of a rural sect.

At the same time, Titus, the conqueror of Jerusalem, formed a public union with Berenice, great-granddaughter of Herod the Great and a Hasmonean princess.
Ancient sources report that he intended to marry her and faced resistance in Rome because of it \cite[66.15]{cassiusdio:romanhistory} \cite[Titus 7]{suetonius:caesars}.
This was not a private liaison but a dynastic calculation.
In Hellenistic politics, marriage to a rival royal house is the mechanism of legitimacy, the way an emperor absorbs a throne he has conquered.
You eliminate rebels, but you marry queens.

The same house then took over the prophecy that had made the bloodline dangerous.
Josephus writes that what most emboldened the Jews to the war was an ambiguous oracle in their sacred writings that ``about that time, one from their country should become governor of the habitable earth,'' and he resolves the ambiguity himself: the oracle denoted Vespasian, appointed emperor in Judea \cite[6.312--313]{josephus:war}.
Tacitus records the same conviction, that ``men starting from Judea should possess the world,'' and adds that the prophecy had in reality pointed to Vespasian and Titus \cite[5.13]{tacitus:histories}.
Suetonius calls it an old and established belief spread over the whole East, fulfilled in a Roman emperor, and notes that Vespasian had been given the Judean command partly because his family was too obscure to fear \cite[Vespasian 4]{suetonius:caesars}.
Josephus delivered the identification in person, in chains before his captor: ``Thou, O Vespasian, art Caesar and emperor, thou, and this thy son'' \cite[3.8.9]{josephus:war}; Suetonius still lists that prophecy among the omens of Vespasian's rise \cite[Vespasian 5]{suetonius:caesars}.
A dynasty with no royal ancestry took its legitimating oracle from the sacred books of the province it had just crushed.

The Flavian house did not treat the Herodian-Hasmonean line as fiction.
Rome's actions confirm that the Davidic-Herodian bloodline was recognized as real royalty within imperial politics, not as a peasant movement retroactively glorified.
Elimination, marriage, and appropriation are three distinct policies, and the record attests each one: the hunts in three passages of Eusebius, the marriage project in Cassius Dio and Suetonius, the prophecy transfer in five passages of Josephus, Tacitus, and Suetonius --- ten passages by five authors, all trained on the royal claims of one small province, a convergence too wide for coincidence.
The high command reasoned the same way in its own council: in the war council preserved by Sulpicius Severus --- taken up again in Chapter 6 --- Titus orders the Temple destroyed so that, the root once destroyed, the branch of Jews and Christians alike would perish \cite[2.30.6--7]{sulpicius:chronica}.
...
Melchior reflects a title associated with the Zoroastrian concept of the royal light (\emph{khvarenah}), the divine radiance that legitimized kingship---hence “king of light” or “keeper of light.”
...
Each pairing is anchored in cult practice rather than sentiment: frankincense is the priestly offering of Israel’s cult (Lev 2:1--2, 24:7), and myrrh is the first and largest ingredient of the holy anointing oil by which Israel consecrated its rulers (Exod 30:23--25) and the perfume on the king’s garments in the coronation psalm (Ps 45:8).
...
Mark preserves the military pairing even in parody: the soldiers who dress Jesus in purple and kneel before him in mock homage then lead him out and offer him wine mixed with myrrh (Mark 15:17--20, 23).
...
Matthew does not name \emph{khvarenah}; he simply uses the system’s moves: omen → embassy → obeisance → investiture gifts.

The earliest witness to the names is a sixth-century Greek chronicle written by an Alexandrian Christian, surviving only in a corrupt Latin translation: \textit{magi autem vocabantur Bithisarea Melchior Gathaspa}, “the Magi were called Bithisarea, Melchior, Gathaspa” \cite[86]{excerpta:barbari}.
The spelling is mangled, but the triad behind it is Balthazar, Melchior, and Caspar.

What the later witnesses do with the pairing is the strongest sign that they had inherited it rather than devised it.
They get it wrong, and they do not get it wrong the same way.
The treatise attributed to Bede hands the gold to Melchior and the frankincense to Caspar---the two exactly swapped \cite{pseudobede:excerpta}.
A Coptic potsherd from Jēme, written a century or two later, restores frankincense to Melchior but gives the gold to Balthazar and drops Caspar from the list entirely \cite[7]{stefanski:coptic-ostraca}.
Two witnesses, two arrangements, and neither puts the gold in the treasurer’s hands.
A tradition that invented these names to furnish Matthew’s gifts with bearers would have made that match and kept it, because the match would have been the whole point of the invention.
Scribes who thought they were copying three personal names had no reason to care which gift went with which, and no way to notice that they had handed the minister of the treasury a censer.

The same treatise shows how far the sense had gone.
It specifies each Magus’s age, hair, complexion, tunic, and footwear, and explains what every gift means---gold for the king, frankincense for the god, myrrh for the man who will die \cite{pseudobede:excerpta}.
It says nothing about what the names mean \cite{pseudobede:excerpta}.
A writer who records the color of Balthazar’s shoes would not have withheld the meaning of his name had he known it.
...
When a new Pope is installed, he receives the golden Fisherman’s Ring and is incensed with frankincense \cite{ordo:petrini}.
When a grandmaster of a military order is chosen, he is invested with myrrh.
The oil itself kept myrrh’s name: the Septuagint names the myrrh oil of Exod 30:23--25 both \emph{chrisma} (χρῖσμα) and \emph{myron} (μύρον) in a single verse (Exod 30:25); the fourteenth-century Byzantine court manual of pseudo-Kodinos has the patriarch anoint each new emperor’s head with μύρον \cite{pseudokodinos:offices}; and the oil consecrated for Charles III at the Church of the Holy Sepulchre in March 2023 was announced under the verse’s other name, chrism \cite{royal:chrism2023}.
...
Had the sixth-century Alexandrian chronicler with remarkable knowledge of ancient Eastern tradition invented them, he would almost certainly have drawn out the symbolism---stating plainly that Caspar was a treasurer, Melchior a priest and keeper of light, and Balthazar a commander or guardian.
...
His works --- \emph{The Jewish War}, \emph{Antiquities of the Jews}, \emph{Life}, and \emph{Against Apion} --- were written in Greek for a Roman audience, with the aim of portraying Jewish tradition as ancient and respectable.
...
In book 18 of the \emph{Antiquities}, written in 93 AD, Josephus records \cite[18.63--64]{josephus:ant}:
...
This passage, the so-called \emph{Testimonium Flavianum}, has been endlessly debated.
...
The force of Josephus’ testimony is even greater when we set it beside another notice, universally accepted as authentic, in book 20 of the \emph{Antiquities}.
...
The \emph{desposynoi} tradition stretches into the second century, where Christian writers continue to mention relatives of Jesus who maintained leadership roles and were treated with special deference.
...
The succession of brothers, the preservation of kinship authority, the interrogation of the family by Domitian, and the later Christian memory of the \emph{desposynoi} all point in the same direction.
...
The Talpiot ossuary uses the specific Greek form \emph{Mariamne} (Μαριάμνη) with the -νη ending, not the common Μαρία or Μαριάμ.
...
These frequencies follow the standard onomastic dataset for Second Temple Jewish names \cite{ilan:lexicon}.
...
Release of a crucified body for burial is attested, and where a source records how it happened, it runs through a grant: Philo knows of men taken down before an emperor's birthday and ``given up to their relations, in order to receive the honours of sepulture'' \cite[83]{philo:flaccum}, and Josephus had three crucified acquaintances taken down only after he petitioned Titus in person \cite[420--421]{josephus:life}.
The one crucifixion victim whose remains have been identified was buried in a rock-cut family tomb at Giv'at ha-Mivtar in Jerusalem, his bones collected into an inscribed ossuary with the iron nail still through the heel \cite{zias:crucified}.
In both cases the release was granted by the authorities, once for an emperor's birthday and once after a personal petition, so the release of a body was itself a political decision.
