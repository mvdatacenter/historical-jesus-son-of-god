...
Eusebius records that Vespasian ordered a search for descendants of David after Jerusalem's fall (HE 3.12), and that Domitian interrogated the grandsons of Jude about their lineage (HE 3.19--20).
He further reports that Trajan executed Simeon son of Clopas as both a Davidic descendant and a Christian (HE 3.32).
Roman authorities treated the Davidic claim as a live political threat across successive reigns.
Titus, conqueror of Jerusalem, planned to marry Berenice, great-granddaughter of Herod the Great and a Hasmonean princess.
This proposed union joined the Flavian house to the Herodian-Hasmonean line through the standard Hellenistic mechanism of dynastic marriage.
Roman emperors sought not only to suppress Jewish royal claims but to absorb them into imperial legitimacy.
