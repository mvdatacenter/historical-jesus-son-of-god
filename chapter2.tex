...
Yet as discussed previously, there is substantial evidence that no independent town named Nazareth existed in the first century.
It is often claimed that the omission is due to Nazareth being too small to note, but this explanation is implausible: a place so obscure that its name was unknown to its immediate neighbors could not have served as a geographic identifier such as “Jesus of Nazareth.”
If, however, Nazareth and Sepphoris were two names for the same urban center—as linguistic, geographic, and historical evidence suggests—then Jesus’ upbringing in “Nazareth” would simply mean he grew up in or near the capital of Galilee itself.
Sepphoris lay at the heart of the province, surrounded by the same towns and roads that dominate the Gospel geography: Cana, Capernaum, Magdala, and Tiberias.
In this reading, “Nazareth” would designate not a forgotten hamlet but a well-known Hellenistic city at the political and cultural center of northern Palestine.
...
Finally, when Helena, the mother of Constantine, visited Palestine in the early fourth century, she located Nazareth precisely where Sepphoris once stood.
As Augusta she commanded immense resources, had access to the best Roman archives, and undertook her research in person.
Her identification resulted in the construction of the Church of the Annunciation, the Church of St.~Joseph, and the Basilica of Jesus the Adolescent—each only a short distance from Sepphoris’ ancient core.
Modern historians often dismiss her testimony outright, yet given her position and proximity to imperial record-keeping, it deserves to be treated with greater seriousness.
