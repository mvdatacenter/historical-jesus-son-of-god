...
\begin{table}[h]
    ...
    \begin{tabular}{|l|p{3.4cm}|p{2.8cm}|p{6.6cm}|}
        \hline
        \textbf{Name (Luke 3)} & \textbf{Proposed Historical Identity} & \textbf{Estimated Lifespan} & \textbf{Notes / Significance} \\ \hline
    ...
    \end{tabular}
    \caption{Luke’s genealogy (Zerubbabel → Jesus) aligned to Hasmonean and priestly dynastic memory, using the exact Lucan names and period-specific identifications.}
