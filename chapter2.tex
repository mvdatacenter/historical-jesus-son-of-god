...
The oil itself kept myrrh’s name: the Septuagint names the myrrh oil of Exod 30:23--25 both \emph{chrisma} (χρῖσμα) and \emph{myron} (μύρον) in a single verse (Exod 30:25); the Byzantine court manual of pseudo-Kodinos has the patriarch anoint each new emperor’s head with μύρον \cite{pseudokodinos:offices}; and the oil consecrated for Charles III at the Church of the Holy Sepulchre in March 2023 was announced under the verse’s other name, chrism \cite{royal:chrism2023}.
