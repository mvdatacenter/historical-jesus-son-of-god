...
In Israel, and surrounding regions, being "of" a place often times was reserved for the elite.

Most people without status were known as "son of" their father, or a "wife of" their husband.
...
Mary of Magdala was the companion of the Lord.
...
So Jesus and Mary Magdalene were both "of" places already indicating a nobility.
...
However, we need to be cognizant that if Mary was indeed very closely tied to Jerusalem, and that is where Jesus traveled to his family for passover, where Jesus died, and was accused to be a king of.
We need to point out there are only two major and very ancient human settlements surrounding Jerusalem.
One is Bethlehem to the south, and one is Ramallah to the north, also know as Ar-Ram in hebrew or Arimathea in greek.
Ar-Ram and Ramallah are separate administrative towns today, but they form a continuous urban settlement.
The areas to the east are desert, and to the west are fairly steep mountains both preventing substantial human settlement to this day.
Both places as well as Jerusalem were prominently mentioned in the old testament.
There would be absolutely no problem linking Jesus to a prophecy in Jerusalem or Ar-Ram had he been born there.
Other than biblical sources, Bethehem is also mentioned in the Protoevangelion of James also claiming a cave birth in Bethlehem.
A specific cave in Bethlehem was already allegedly venerated by Christians in Origen.

Egypt is the most easily accessible place by road or by sea that was not under the rule of Herod.
There is only 100km between Bethlehem and the Egyptian border, that is actually closer than Galilee.
Egypt and Israel were in the same state, Ptolemaic Greece until Roman conquest and were extremely well connected.
Given this was a genuine problem for early Christian apologists and everyone explained it away in the same way, born in Bethlehem but grew up in Galilee, with early childhood spent in Egypt.
...
Based on the best interpretation that tetrarchy would be near Antioch.
...
A plausible reading of the text, could simply refer to the tetrarchy of Galilee.
...
It is also possible Nazareth really referred to the religion that Jesus was practicing.
Paul and other early Christians were called "Nazarenes" and the term is used in the Talmud to refer to followers of Jesus.
