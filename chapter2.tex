...
Origen \cite[1.51]{origen:contracels} reports that Christians were already venerating a specific cave at Bethlehem, which fixes the birth tradition to that site by the middle of the third century.
...
The elements the sources above describe were in place before Jesus was born: the assembly gathered in its best clothing, heard texts read aloud, sang communal hymns, shared a ritual meal of bread and wine, and conducted the formal business of a civic-religious body.
...
Reading a story aloud to an assembly and then drawing its lesson was not a Christian invention: \emph{parabolai} were used in the ecclesia to teach moral and political truths to the assembled citizens.
