...
We have Cicero himself explaining (in \emph{Brutus} 164 and \emph{Ad Atticum} 2.1.3) he used \textit{commentarii} precisely as drafts of speeches and sayings written down by his scribes for him to use later.
...
Aristophanes (\emph{Ecclesiazusae} 408--415) and Demosthenes (\emph{Against Meidias} 133--136) mock ``overdressed youths at the assembly'' and ``citizens displaying wealth before the people.''
