...
The name of Nazareth may be actually quite ancient.
The town of Kinneret was mentioned in many administrative lists of Galilean towns when the area was under Egyptian rule from 15th to 11th century BC.
The town is also mentioned in Joshua and localized with certainty on the northwestern shore of the Sea of Galilee.
When Greeks came with Alexander the Great they called the lake, Lake of Genazaret or Lake Tiberias after the two major towns on its shores, Kinnaret and Tiberias.
A famous historian Strabo, contemporary with Jesus wrote about the Lake and plain of Gennesaritis.
Joesphus describe a lake and plain of Gennesar.
It is worth pointing out that the location of Kinneret is less than two miles from Capernaum where Jesus was based during his ministry.
...
The explanation of this is that Josephus only used Greek names of cities, but the carving of 24 groups who moved there right after the rebellion of Josephus only lists Jewish names of the towns.
The seemingly obvious solution of the problem is that Sepphoris is simply the Greek name of the city of Nazareth.
The Jewish list includes all largest cities but inexplicably does not include Sepphoris, and the Josephus Greek list inexplicably does not contain Nazareth.
We need to note the core of Sepphoris is only 4km from the Nazareth church of annunciation.
Greeks gave greek names to most large cities in the Levant and although some were phonetically similar to the original, most were not.
...
Nazareth is also mentioned in record from the same time as Helena on a carving describing the Jewish resettlement in 70 AD resulting from the Jewish rebellion against Rome.
Nazareth was listed as the destination of two out of 24 settlers.
...
Nazareth may also have referred to the religion that Jesus was practicing.
