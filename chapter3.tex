...
The versions then record the ending growing member by member: the Curetonian Syriac keeps kingdom and glory, Codex Bobiensis power alone, the Sahidic power and might, until the Byzantine text settles on the full triplet with Amen \cite[on Matt.~6:13]{westcotthort:appendix}.
