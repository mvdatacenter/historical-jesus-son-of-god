...
The early translations then record the ending growing member by member: the Curetonian Syriac keeps kingdom and glory, Codex Bobiensis power alone, the Sahidic Coptic power and might, until the later standard Greek text settles on the full triplet with Amen \cite[on Matt.~6:13]{westcotthort:appendix}.
...
The first commentator to expound it is John Chrysostom, preaching at Antioch around 390 \cite[Homily 19]{chrysostom:hommatt}; of the 10 other commentators on the prayer that the apparatus collects---Origen, Cyril of Jerusalem, Gregory of Nyssa, and Maximus in Greek; Tertullian, Cyprian, Hilary, Chromatius, Juvencus, and Augustine in Latin---none reads it in the text, and only Chrysostom's followers do \cite[on Matt.~6:13]{westcotthort:appendix}.
