...
\subsubsection{The Doxology's Manuscript Trail}

For the prayer's royal ending, that circulation can be watched manuscript by manuscript.
The earliest manuscripts of Matthew---Codex Sinaiticus, Codex Vaticanus, Codex Bezae---end the prayer at ``deliver us from the Evil One,'' with no doxology \cite[on Matt.~6:13]{westcotthort:appendix}.
...
So for the first three centuries the doxology lived in the liturgy while the Gospel text still ended at the Evil One.
