...
Alexander the Great claimed descent from Zeus--Ammon, and his image appeared with the horns of Ammon on coins that circulated across the empire \cite[27]{plutarch:lives}.
...
John Hyrcanus was remembered as beloved of God, possessing prophetic gifts and ruling by divine favor \cite[13.299--300]{josephus:ant}.
His sons Aristobulus and Alexander Jannaeus combined priesthood and kingship, and Alexander struck coins inscribed "Jonathan the King" in the same Hellenistic style as the Seleucids \cite[13.320]{josephus:ant}.
Coins of John Hyrcanus I from 135 BCE display the five-pointed star and the Seleucid anchor, the same royal symbols used across the Hellenistic East.
These marks signaled Jewish kingship in the visual grammar of Seleucid power, showing active adoption rather than passive tolerance of Hellenistic rule.
Josephus describes them with titles such as "savior" and "chosen of God" \cite{josephus:ant}, categories which in the wider Greek world carried unmistakable divine resonance.
...
Dead Sea Scroll 4Q246 applies the titles ``Son of God'' and ``Son of the Most High'' to an eschatological ruler before any Christian usage.
Justin Martyr states in First Apology 21--22 that Christians ``propound nothing different from what you believe regarding those whom you esteem sons of Zeus,'' naming Heracles, Asclepius, Dionysus, and Perseus.
He argues from shared Greco-Roman categories of divine sonship rather than from Jewish exclusivity.
Theophilus of Antioch likewise cites Heracles ascending after the pyre and Asclepius struck by thunderbolt and taken to heaven, naming eyewitness tradition as part of the pattern.
In the Via Latina catacomb in Rome, Heracles raising Alcestus appears beside Jesus raising Lazarus, visually placing both sons of God within the same heroic framework.
Psalm 2:7 is applied in the New Testament to the annunciation (Luke 1:32--35), to the baptism in the Western text of Luke 3:22, and to the resurrection (Acts 13:33).
Three traditions attach the same royal formula to three separate events.
The phrase operates as a moment of investiture in which a king receives his status, not as a statement about eternal essence.

Paul's opening lines to Rome give the formula in its full two-part form.
Jesus was τοῦ γενομένου ἐκ σπέρματος Δαυὶδ κατὰ σάρκα, ``born of the seed of David according to the flesh,'' and τοῦ ὁρισθέντος υἱοῦ θεοῦ ἐν δυνάμει \ldots ἐξ ἀναστάσεως νεκρῶν, ``designated Son of God in power \ldots by resurrection from the dead'' (Romans 1:3--4).
The first half is descent; the second is an appointment, made by an act of power at a named event.
That these two verses are a creed older than the letter, which Paul quotes rather than composes, is the common reading among historians of early Christian belief \cite{hurtado:lordjc}.
The priestly decrees of Ptolemaic Egypt are built the same way.
The Rosetta Stone opens on Ptolemy~V as παραλαβόντος τὴν βασιλείαν παρὰ τοῦ πατρός, ``who received the kingship from his father,'' ἐκγόνου θεῶν Φιλοπατόρων, ``offspring of the Father-loving Gods,'' and εἰκόνος ζώσης τοῦ Διός, υἱοῦ τοῦ Ἡλίου, ``living image of Zeus, son of the Sun'' (OGIS 90, lines 1--3).
The priests, gathered at Memphis for ``the festival of the taking-over of the kingship'' (lines 7--8), declare him θεὸς ἐκ θεοῦ καὶ θεᾶς καθάπερ Ὧρος ὁ τῆς Ἴσιος καὶ Ὀσίριος υἱός, ``a god from a god and a goddess, as Horus the son of Isis and Osiris'' (line 10), resolve ``to increase greatly'' his honours as ``the god Manifest and Gracious'' (lines 36--38), and order the title ``entered in all documents'' (line 51).
Descent stands in the first lines, divine sonship in the priests' resolution, and the accession day becomes a monthly feast (line 47).
The Canopus decree of 238~BC shows the same machinery at a death.
The king's daughter Berenice βασίλισσα εὐθέως ἀπεδείχθη, ``was at once designated queen,'' then μετελθεῖν εἰς τὸν ἀέναον κόσμον, ``passed suddenly into the everlasting world,'' and the priests persuaded the king ``to establish the goddess with Osiris'' in the temple at Canopus, dating her feast from the month ἐν ᾧ ἡ ἀποθέωσις αὐτῆς ἐν ἀρχῇ ἐγενήθη, ``in which her deification first took place'' (OGIS 56, lines 46--57).
Beside the decrees, Romans 1:3--4 reads as the public form of a Hellenistic royal title: birth from a royal line, then divine sonship declared in power at a dated event, in Paul's case a death, as at Canopus.
Acts keeps the decree's verb for Jesus: ἄνδρα ἀποδεδειγμένον ἀπὸ τοῦ θεοῦ εἰς ὑμᾶς δυνάμεσι, ``a man designated by God to you by powers'' (Acts 2:22), and ``God has made him both Lord and Christ'' (Acts 2:36).
...
Qumran---the site near the Dead Sea where the Dead Sea Scrolls were discovered---alone preserved over nine hundred manuscripts from approximately 250 BC to 70 AD (catalogued in E.~Tov, \emph{Revised Lists of the Texts from the Judaean Desert}, Leiden, 2010).
...
Philo also describes the Therapeutae near Lake Mareotis as a community devoted to copying and storing sacred books \cite{philo:contempl}.
...
Josephus mentions "James, the brother of Jesus who was called Christ" \cite[20.200]{josephus:ant} and records his execution in 62 AD .
...
Preaching in Athens he quotes the hymn to Zeus: "For we are indeed his offspring" (Acts 17:28) \cite[5]{aratus:phaenomena}.
...
Philo of Alexandria had already developed a theology of the Logos before the New Testament was written \cite{philo:opificio}, and his influence is visible in both Johannine and Pauline language.

Later Christian writers expressed the synthesis openly.
Clement of Alexandria \cite[5.12]{clement:stromata} wrote: "God is one and the same, the universal Father, being known under many names."
...
Early Christian images appropriate imperial posture and celestial framing for Christ.
A depiction of Jesus at a well uses the same commanding stance as the Prima Porta Augustus, and other compositions show Christ flanked by stars in a manner that mirrors imperial Helios imagery such as that associated with Hadrian's mausoleum.
This is deliberate transfer of imperial visual authority to Jesus.
...
\subsubsection{The Royal Ending's Manuscript Trail}

For the prayer's royal ending, that circulation can be watched manuscript by manuscript.
The earliest manuscripts of Matthew---Codex Sinaiticus, Codex Vaticanus, Codex Bezae---end the prayer at ``deliver us from the Evil One'' \cite[on Matt.~6:13]{westcotthort:appendix}.
The earliest expositions match: Tertullian around 200 and Cyprian around 250 expound the prayer clause by clause and stop at the deliverance petition \cite[2--8]{tertullian:oratione} \cite[9--27]{cyprian:oratione}.
Yet the Didache already closes the prayer with an acclamation---ὅτι σοῦ ἐστιν ἡ δύναμις καὶ ἡ δόξα εἰς τοὺς αἰῶνας, ``for thine is the power and the glory for ever''---and orders it prayed three times a day \cite[8.2--8.3]{didache}.
The same power-and-glory pair seals both of its eucharistic prayers \cite[9.4, 10.5]{didache}: three acclamations in one short manual.
So for the first three centuries the acclamation lived in the liturgy while the Gospel text still ended at the Evil One.
The early translations then record the ending growing piece by piece: the Curetonian manuscript of the old Syriac translation has kingdom and glory, the old Latin manuscript Bobiensis has power alone, and the Sahidic Coptic translation has power and might, until the later standard Greek text has the full triplet with Amen \cite[on Matt.~6:13]{westcotthort:appendix}.
The full form reaches a service book before it reaches a commentary: the Apostolic Constitutions prescribe the prayer with kingdom, power, and glory at its close \cite[on Matt.~6:13]{westcotthort:appendix}.
The first commentator to expound it is John Chrysostom, preaching at Antioch around 390 \cite[Homily 19]{chrysostom:hommatt}.
Ten other commentators wrote on the prayer---Origen, Cyril of Jerusalem, Gregory of Nyssa, and Maximus in Greek; Tertullian, Cyprian, Hilary, Chromatius, Juvencus, and Augustine in Latin---and none of them has the ending in his text; only Chrysostom's followers do \cite[on Matt.~6:13]{westcotthort:appendix}.
Three centuries of daily use pulled the full formula---kingdom, power, and glory---into the Gospel text.
That the ending was added is not a finding of this book; the standard reference works print it, and a reader can open each.
The standard commentary on the Greek New Testament reads the same witnesses and concludes that the ending ``was composed (perhaps on the basis of 1 Chr 29.11--13) in order to adapt the Prayer for liturgical use in the early church'' \cite[on Matt.~6:13]{metzger:textual}.
Bibles set from that Greek text end the verse at the Evil One and carry the ending in a footnote: ``Other ancient authorities add, in some form, For the kingdom and the power and the glory are yours forever. Amen'' \cite[Matt.~6:13, note]{nrsv:ue}.
The Catechism of the Catholic Church teaches the same history---``Very early on, liturgical usage concluded the Lord's Prayer with a doxology''---and names the same two witnesses this trail began with, the Didache and then the Apostolic Constitutions, which ``add to the beginning: `the kingdom''' \cite[2760]{ccc}.
The trail dates the ending's entry into Matthew; for the first century it attests the congregations' acclamation in the Didache, not the wording of the Gospel.
The royal inscriptions named above give the idiom; the oldest parallels that can be quoted word for word are scriptural, and they too are the language of kingship.
Daniel has the courtier tell the king of kings, ``the God of heaven hath given thee a kingdom, power, and strength, and glory'' (Daniel 2:37): the set names what a king holds.
David's blessing before the assembly hands the same set to God as king: ``thine, O Lord, is the greatness, and the power, and the glory\ldots{} thine is the kingdom'' (1 Chronicles 29:11).
The congregations' acclamation repeats that second move---the words a king holds, handed to God alone---and 1 Chronicles 29:11 shows a congregation making it before Jesus.
...
The seven-day planetary week, systematized in Ptolemaic Alexandria \cite[37.18--19]{cassiusdio:romanhistory}, was the framework Christians adopted.
...
Amun-Ra's main adjective was ``it nṯrw,'' the father of the gods, with many prayers calling him ``the one who makes mankind, who formed all that lives, father of the fathers of all the gods'' (Papyrus Leiden I~350, stanza 200; \cite{assmann:searchgod}).
The hymn to Aten calls the Sun ``the father of all that he made'' \cite{hymn:aten}.
...
\begin{itemize}
    \item \textbf{Acts (cosmic Father; Kyrios to Jesus):} Acts 2:36 --- “God has made him both \emph{Kyrios} and Christ, this Jesus whom you crucified.” Acts 17:28--29 (Areopagus) --- “For we are indeed his offspring… we ought not to think that the divine being is like gold or silver or stone.” Paul quotes Greek poets (Aratus/Cleanthes) \cite[5]{aratus:phaenomena} to assert universal Fatherhood, not a tribal deity.
...
Mary is identified in Luke 1:36 as the συγγενίς (\textit{syngenís}) of Elizabeth, which means she belongs to the same blood-kin network as a Judean priestly household rather than to an isolated Galilean family, and this immediately places Jesus' maternal line inside the orbit of Jerusalem's ancestral priesthood.
...
Early Jerusalem ossuaries bearing the name Ἰησοῦς are inscribed in Greek rather than Hebrew or Aramaic, and some include the ichthus symbol.
The fish functions as the acrostic Ἰησοῦς Χριστός Θεοῦ Υἱός Σωτήρ, a compact confession built entirely from Greek royal titles---Christ, Son of God, Savior.
This is archaeological evidence that the earliest believers articulated Jesus's identity in Greek theological language embedded in the wider imperial vocabulary of the eastern Mediterranean.
...
Josephus proclaims Vespasian as the ruler foretold in Jewish prophecy \cite[3.8.9]{josephus:war}, and rabbinic tradition reports Yohanan ben Zakai greeting him as king.
Suetonius (\emph{Vespasian} 4--5) and Tacitus \cite[5.13]{tacitus:histories} confirm that contemporary expectation identified Vespasian with the Jewish oracle of world rule.
Messianic language functioned as a transferable imperial title applied to any ruler who fulfilled the political pattern.
...
Plutarch records that Plato's conception involved divine agency described with the terms \emph{dynamis} (δύναμις) and \emph{pneuma} (πνεῦμα).
Luke 1:35 uses the same vocabulary of power and spirit to describe Jesus's conception.
...
The Stoics, particularly Zeno of Citium (c.~334--262 BCE) and later Chrysippus, played a significant role in further developing the idea of Logos \cite[7.134--147]{diogenes:lives}.
...
Philo of Alexandria belonged to the narrow Jewish aristocracy of the city, a circle defined by immense wealth, political leverage, and constant dealings with the Herodian court \cite{philo:legatio}.
His brother Alexander the Alabarch lent money to Herodian rulers, and Alexander's son married Berenice \cite[18.159; 19.276--277]{josephus:ant}, which placed the family in the same diplomatic and financial orbit as the royal house.
...
Notably Philo described the Logos as the firstborn son of God \cite[146]{philo:confusione}, and so the rightful heir to the throne and the intermediary between God and the world.
...
Epiphanes is a title given to multiple rulers, such as Antiochus IV and Ptolemy V \cite{polybius:histories}.
...
Horace portrays Augustus as the embodied presence of Mercury dwelling among humans in lasting form (\emph{Odes} 1.2.41--52).
The god is not a temporary visitor but a permanent incarnation within the ruler.
...
It is not a one-time vague reference, but a motif so widespread throughout the ancient world and many centuries that even Pliny the Elder noted it in his \cite[37.60]{pliny:nh}.
...
During confession of sins in ancient Egypt, the following was said in the Hymn to Amun (Papyrus Leiden I 350) \cite{assmann:searchgod}:
\begin{quote}
...
Hammurabi, in the prologue to his law code (col.~i, lines 27--49), called himself ``Enlil's chosen shepherd.''
...
Let's also note that Plato taught that a true philosopher-king is a good shepherd \cite[275b--c]{plato:statesman}.
The earliest surviving images of Jesus overwhelmingly portray him as the Good Shepherd in the pose of Hermes Criophorus, the ram-bearing god.
The body stance, draped garment, and animal across the shoulders reproduce established Greek divine iconography rather than Jewish temple imagery.
This is material evidence that early Christians presented Jesus through Hellenistic visual forms.
...
The title crossed dynasties: the Seleucid Antiochus~I was also known as ``Soter,'' and the practice continued through successor kingdoms to the end of the Hellenistic period.
...
King of Kings and Lord of Lords was a title used for the rulers of empires, not only Greeks, but also of Persia---the Behistun Inscription of Darius~I (DB~I) uses ``King of Kings'' (\emph{xšāyaθiya xšāyaθiyānām})---and India.
...
However, notably again, Amun was called ``Lord of Lords'' (\emph{nb nbw}) as one of his primary titles (Papyrus Leiden I 350, Hymn to Amun, stanza 200).
...
Ptolemy~V Epiphanes, celebrated on the Rosetta Stone (OGIS 90), was called the bringer of peace.
Octavian Augustus was hailed as bringer of peace: the \emph{Res Gestae Divi Augusti} 13 records that the gates of Janus were closed three times during his reign---signaling universal peace---and Augustan coinage carried PAX legends after his victory at the Battle of Actium in 31 BC.
...
Here the title relates to the cave from Plato's Republic \cite[514a--520a]{plato:republic}.
...
Claimed sonship of Zeus--Ammon after visiting the oracle at Siwa in Egypt \cite[27]{plutarch:lives}.
Depicted with ram’s horns of Ammon on coinage.
Arrian and Plutarch testify to Alexander's divine self-understanding and the cult that followed him \cite{plutarch:lives}.
...
Ptolemy I Soter received the epithet "Soter" (Savior) and initiated the cult of Serapis \cite[4.83--84]{tacitus:histories}.
Ptolemy II Philadelphus and his sister-wife Arsinoë II were hailed as \textit{Theoi Adelphoi} (Sibling Gods).
Ptolemy III Euergetes was called ``Benefactor'' (Canopus Decree, OGIS 56), and the poet Callimachus linked his reign to a new constellation (\emph{Aetia} fr.~110 Pfeiffer).
...
Seleucus I Nicator claimed descent from Apollo, a story reported by Appian and other sources \cite[56]{appian:romanhistory}.
Seleucid tradition reported that Apollo conceived Seleucus I and marked the event with an anchor, given either as a ring or impressed upon the mother's flesh.
This narrative combines divine paternity with a physical sign of legitimacy, a structure later echoed in Gospel annunciation scenes.
Antiochus~I Soter received his title for defeating the Galatians and was worshipped alongside Apollo.
Antiochus~II received the title ``Theos'' (God) from the citizens of Miletus for liberating their city.
Antiochus~III Megas was hailed as ``the Great'' after his eastern campaigns (OGIS 245) and received divine honors (\emph{isotheoi timai}) from the city of Teos.
...
The ruler cult tradition continued in successor states: Antiochus~I Theos of Commagene, who claimed Seleucid descent through his mother, built the syncretic sanctuary at Nemrud Dağ linking Zeus, Apollo, and Mithra (OGIS 383).

\paragraph{Attalid Dynasty of Pergamon (281--133 BC).}
Attalus~I Soter and his successors styled themselves as ``Soter'' and established divine cults (IvP I 15--19).
...
Strato II, the last of the Indo-Greek kings in the Punjab, bore the epithet “Soter.”
Kings of Pontus, notably Mithridates VI Eupator, claimed descent from both Dionysus and Alexander, presenting themselves as semi-divine world rulers \cite{appian:romanhistory}.
...
Coins circulating in Jesus's lifetime bore the Greek inscription \emph{theos sebastos kaisar} (θεὸς σεβαστὸς Καῖσαρ), declaring Augustus Caesar as god.
Such a coin is the most plausible type present in the "render unto Caesar" exchange in Mark 12:17.
Jesus answers while holding an object that equates Caesar with God and separates their claims.
...
Ptolemy III (246--222 BC) was linked to a celestial sign through the poet Callimachus, who immortalized the story of Berenice's Lock---a lock of hair dedicated for the king's safe return that was said to have become a new constellation, Coma Berenices (\emph{Aetia} fr.~110 Pfeiffer).
The tradition of celestial signs confirming divine kingship was transferred to the Roman empire, where the birth of Augustus was also represented as a new star in the sky, and so was the death and deification of Julius Caesar.
Suetonius reports that portents announced the birth of a world ruler, that the Senate decreed no male child born that year should be raised, that Augustus was conceived through Apollo at his temple, and that witnesses later claimed to see him ascend after death (Divus Augustus 94).
These are the same narrative elements found in Matthew: a threatened infant under a royal decree, divine conception, and post-mortem appearances.
The template of celestial sign, endangered child, divine sonship, and exaltation serves two rival claimants to universal rule.
Seleucid coins depicted Zeus alongside a star to signal divine rule, extending the same celestial language across the Greek East.
Portents and celestial omens were integral to the legitimation of rule across the ancient world, situating the Gospel nativity star within a tradition that ran from Alexander through the Ptolemies and Seleucids to Rome.
Philo describes Moses at death as transformed, his mind shining like the sun and rising as a star from the earthly realm \cite{philo:vimoysis}.
This imagery places Moses within the same celestial-deification tradition found in Hellenistic royal ideology.
Star-ascent symbolism operated across Jewish and Greco-Roman thought before its application to Jesus.
...
The title ``Mother of God'' (Θεοτόκος, \textit{Theotókos}) crystallizes what is already implied in Luke.
...
The claim was already cult language for Isis: the stele text Diodorus records in the first century BC has her announce, ``I am the mother of Horus the king'' \cite[1.27]{diodorus:library}.
...
Egypt had already joined the two claims --- mother of the god, yet untouched --- in one goddess in the generations just before Jesus.
At Sais the statue of Athena, whom Plutarch says the Egyptians held to be Isis, bore the inscription ``I am all that has been, and is, and shall be, and my robe no mortal has yet uncovered'' \cite[9]{plutarch:deiside}, and the fuller text preserved by Proclus completes the declaration: ``the fruit I brought forth became the sun'' \cite[Book 1, on Timaeus 21e]{proclus:intimaeum}.
The myth holds the same line: Osiris fathered Harpocrates, the child Horus, after his own death \cite[19]{plutarch:deiside}, the child was born ``about the time of the winter solstice'' \cite[65]{plutarch:deiside} --- the season later fixed for Christmas --- and Diodorus twice records Isis's vow never to marry another man \cite[1.22, 1.27]{diodorus:library}.
The pairing was still on public display in Roman Alexandria, and on the later Christian feast date itself: Epiphanius records that ``on the very night of Epiphany'' the worshipers at the Koreion (Κόρειον), ``the precinct of Kore,'' kept an all-night vigil of song, descended at cockcrow with torches into an underground shrine, carried up a wooden image marked on brow, hands, and knees with five gold seals in the shape of a cross, circled the innermost temple with it seven times, and explained the mystery in these words: ταύτῃ τῇ ὥρᾳ σήμερον ἡ Κόρη (τουτέστιν ἡ παρθένος) ἐγέννησε τὸν Αἰῶνα, ``at this hour today the Kore---that is, the virgin---has given birth to Aion'' \cite[51.22]{epiphanius:panarion}.
Epiphanius reports the rite as a hostile witness --- for him the leaders of the idol cults were ``compelled to confess a part of the truth'' --- and adds that the same festival was kept at Petra, the metropolis of Arabia, where the virgin was hymned in Arabic under the name Chaamou \cite[51.22]{epiphanius:panarion}.
He even counts the feast's date from the sun, placing it thirteen days after ``the beginning of the increase of the light'' \cite[51.22]{epiphanius:panarion} --- the same solstice reckoning Plutarch used for the birth of Harpocrates.
...
The primary reference is to Israel as a people, but already in the third century authors like Hippolytus read this woman also as Mary, mother of the messianic king \cite{hippolytus:daniel}.
...
Isis carried the title itself: in Apuleius she names herself queen of heaven, natural mother of all things, and Queen Isis, the name by which the Egyptians worship her \cite[11.5]{apuleius:metamorphoses}.
...
Justin Martyr \cite[100]{justinmartyr:trypho} and Irenaeus \cite[3.22.4]{irenaeus:advhaer} both set up a deliberate contrast: as Eve's disobedience leads to death, Mary's assent leads to life.
...
The \emph{Protoevangelium of James} \cite[4--8]{protoevangelium} deepens the pattern by portraying Mary as ``set apart for the Lord'' from infancy, raised in the Temple, and chosen as a uniquely pure bride.
...
Ptolemaic and Seleucid Kings often sent out ἀπόστολοι (\textit{apóstoloi}) as official emissaries or envoys on diplomatic missions.
...
\begin{enumerate}
    ...
    \item Restoration becomes possible only through \texthebrew{תְּשׁוּבָה} (\textit{teshuvah}, return/repentance)---a turning back to God and covenant faithfulness.
...
Josephus, writing after the catastrophic destruction of Jerusalem in 70 AD, interprets the Roman victory as God abandoning the rebels and punishing the nation for its transgressions \cite[5.19]{josephus:war}.
...
In classical Greek, \textit{hamartia} meant ``missing the mark'' or ``error,'' especially errors in judgment---Aristotle uses it in the \textit{Poetics} (1453a) \cite[1453a]{aristotle:poetics} for the tragic flaw or misjudgment that brings down a hero.
...
In the Hebrew Bible, the corresponding term is \texthebrew{תְּשׁוּבָה} (\textit{teshuvah}), which literally means ``return'':
...
Plato's \textit{Republic} and \textit{Laws}, Aristotle's \textit{Politics}, and later historians like Polybius \cite{polybius:histories} all argue that a city's character---the justice, wisdom, and virtue (\textit{aretē}) of its citizens and rulers---determines its fortune.
...
In Aeschylus's \textit{Persians} \cite{aeschylus:persians}, the defeat of Xerxes is interpreted as divine nemesis for the hubris of attempting to enslave Greece.
...
Polybius, writing after witnessing the Greek collapse, attributed it to moral decay \cite{polybius:histories}: when elites abandoned civic duty for private luxury, when solidarity gave way to factionalism, the cities lost the internal cohesion necessary to resist conquest.
