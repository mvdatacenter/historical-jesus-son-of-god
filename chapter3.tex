...
The parable of Lazarus and the rich man follows the demotic Egyptian Setne II cycle (Setne Khamwas, BL Demotic Papyrus 604), a ghost narrative dated paleographically to the mid-first century CE.
Setne sees a rich man buried in fine linen with great display and a poor man laid in a mat without mourners, then his son Si-Osiri takes him to the netherworld and shows the reversal, with the rich man tormented by the door-pivot of the seventh hall driven through his eye and the poor man clothed in fine linen near Osiris in honor.
Si-Osiri states the moral that it is better to receive good on earth in the netherworld than not to receive it.
Luke 16 reproduces the same structure with a rich man in purple and a beggar at his gate, both die, the rich man is tormented, the poor man is carried to Abraham's bosom, and the reversal is explained, ``in thy lifetime thou receivedst thy good things, and likewise Lazarus evil things; but now he is comforted, and thou art tormented'' (Luke 16:25).
The anchor is the naming, since Lazarus is the only named figure in a Lukan parable while other parable characters remain unnamed, and the Egyptian source leaves its poor man unnamed.
The coda fixes the link to the Gospel narrative, ``neither will they be persuaded, though one rose from the dead'' (Luke 16:31), and John 11 narrates a Lazarus who is called from the tomb and rises.
The same rich-poor underworld scene appears again in the Apocalypse of Peter in the Achmim manuscript recovered in Egypt.
This is not a general Hellenized afterlife motif but the demotic Egyptian topography of judgment and reversal rendered into a Greek Gospel parable, with the Lazarus naming as the distinguishing mark.
