...
Seleucid kings bore divine titles as standard: Antiochus~I was ``Soter'' (Savior), Antiochus~II was ``Theos'' (God), and Antiochus~III was hailed as ``Megas'' (the Great) (OGIS 245).
...
King of Kings was a title used for the rulers of empires, not only Greeks, but also of Persia (the Behistun Inscription of Darius~I, DB~I, uses \emph{xšāyaθiya xšāyaθiyānām}) and India.
...
Antiochus~III Megas was hailed as ``the Great'' after his eastern campaigns (OGIS 245).
Antiochus~IV Epiphanes explicitly styled himself as ``God Manifest.''
The ruler cult tradition continued in successor states: Antiochus~I Theos of Commagene built the syncretic sanctuary at Nemrud Dağ, linking Zeus, Apollo, and Mithra (OGIS 383).
...
The Canopus Decree (238 BC, OGIS 56), issued by Egyptian priests to honor Ptolemy III, demonstrates the king's association with cosmic order: it orders the addition of a leap day to the Egyptian calendar and honors the royal family for military campaigns and religious patronage.
Callimachus (Greek Poet, 3rd Century BC) In his \emph{Aetia} (fr.~110 Pfeiffer), Callimachus referenced Berenice’s Lock, a constellation myth that was linked to a celestial omen for Ptolemy III .
