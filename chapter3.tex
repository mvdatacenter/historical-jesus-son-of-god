...
The Lord's Prayer is close mixed into these three sayings, and the prayer is introduced with the description of God as the hidden Father.
And what is striking these are not insignificant parts of the story.
Almsgiving, prayer, and fasting are the three pillars of Lent, always central to Christian faith, and the Lord's Prayer is probaby the most cited text to ever have been written by anyone in history.
At the same Matthew very tries to deliberately show deep faithfulness to Second Temple Jewish piety.
He citest the Prophets everywhere he can and it is almost inconceivable that he would knowingly introduced the core belief of Egyptian royal theology into his Gospel.
...
\subsection{Collective Sin and Kingdom Restoration in Second Temple Political Theology}\label{subsec:collective-sin-and-kingdom-restoration}
...
But this individualistic, pietistic interpretation is anachronistic when applied to first-century Jewish apocalyptic movements operating under foreign occupation.
In the political theology of Second Temple Judaism, sin, foreign rule, and national restoration were not separate categories but tightly interwoven strands of a single framework: the Deuteronomistic theology of exile and return.
...
This is not merely theological speculation; it is the explicit interpretive lens through which Jewish writers of the late Second Temple period understood their own political condition under successive foreign powers---Babylonian, Persian, Greek, and finally Roman.
...
The Greek word ἁμαρτία (\textit{hamartia}), typically translated ``sin,'' carries this collective-political dimension throughout Second Temple literature.
...
This political framework was not hidden or implicit---it was embedded in the daily liturgical life of every Christian through the Lord's Prayer.
The concluding doxology, preserved in Greek liturgy and repeated by Christians for centuries, reads: ὅτι σοῦ ἐστιν ἡ βασιλεία καὶ ἡ δύναμις καὶ ἡ δόξα (``For yours is the kingdom and the power and the glory'').
The word used here is not ``kingdom of God'' but simply ἡ βασιλεία---\textit{the} kingdom, \textit{the} empire.
No qualifier softens it.
This is the same term used across all Greek political literature---Herodotus, Xenophon, Polybius, Josephus, Philo, the Septuagint---to denote concrete imperial sovereignty, territorial dominion, the realm of a king.
There is no semantic shift, no metaphorical usage; βασιλεία meant one thing in ancient Greek: political rule over a defined territory and people.

The triplet βασιλεία/δύναμις/δόξα (kingdom/power/glory) is not Christian invention.
It appears in Hellenistic royal cult inscriptions as standard acclamation language for Ptolemaic and Seleucid kings, and later for the Roman emperor in Greek provinces.
When Christians recited this formula daily, they were performing a loyalty transfer: not Caesar's empire, not Rome's power, not the emperor's glory, but \textit{yours}---God's.
This is the exact structure of an imperial oath of allegiance.
To recite it was to declare, in the hearing of one's household and community, that one's ultimate political loyalty belonged not to the occupying power but to the coming kingdom of God.

No Roman official hearing this prayer would mistake it for private piety.
It was sedition spoken aloud, a daily public declaration that the current imperial order was illegitimate and that God's empire would replace it.
This explains why early Christians were not persecuted for strange beliefs but for refusal to perform the emperor cult---because they were already performing a rival imperial cult, declaring daily that \textit{the} kingdom belonged to their Lord, not to Caesar.

\subsection{Civic Virtue and the Love Ethic as Political Program}\label{subsec:civic-virtue-and-love-ethic}

The ethical core of Jesus' teaching---love of neighbor, care for the poor, forgiveness of enemies, inclusion of outcasts---is often presented in modern interpretation as evidence \textit{against} a political reading of his mission.
If Jesus was truly concerned with restoring the Kingdom of God as a territorial-political reality, the argument goes, why would he focus so intensely on internal moral transformation, personal virtue, and interpersonal ethics?
This objection, however, rests on a false dichotomy that would have been unrecognizable to Jesus' Greek-speaking audiences.
In both Greek political philosophy and Second Temple Jewish theology, there was no separation between civic virtue and political stability, between the moral character of a people and their worthiness for sovereignty.
The love ethic was not an alternative to political restoration; it was the necessary foundation for it.

In Greek political thought from Plato through Polybius, the connection between the virtue (\textit{aretē}) of citizens and the health of the \textit{polis} was axiomatic.
Plato's \textit{Republic} argues that justice in the city is inseparable from justice in the soul: a city characterized by wisdom, courage, moderation, and justice will flourish; a city ruled by vice, greed, and disorder will collapse from within or fall to external enemies.
Aristotle's \textit{Politics} similarly holds that the purpose of political community is not merely survival or economic prosperity but the cultivation of virtue and the good life.
A polity composed of citizens who lack \textit{philia} (civic friendship, solidarity) cannot endure; internal division makes conquest inevitable.
Polybius, writing in the second century BC after witnessing the collapse of the Greek city-states and the Hellenistic kingdoms, attributes their downfall to moral decay: when elites abandoned civic duty for private luxury, when solidarity gave way to factionalism, the cities lost the internal cohesion necessary to resist Rome.

This was not merely philosophical theory; it was the lived experience of the Greek world under Roman domination.
...
For any movement seeking to restore the sovereignty of these territories, the first task was not military but moral and political: to rebuild the civic solidarity that had been lost.
This is where Jesus' love ethic enters not as a retreat from politics but as a precondition for political restoration.

``Love your neighbor as yourself'' (Mark 12:31, citing Leviticus 19:18) is not a private moral platitude.
In its original Hebrew and Greek contexts, ``neighbor'' (\textit{re'a}, πλησίον) referred to members of the covenant community---fellow citizens of the people of God.
To love one's neighbor is to rebuild the bonds of trust, mutual obligation, and solidarity that make a people capable of collective action.
In a fragmented, occupied society riven by collaboration and betrayal---where some Jews worked with Roman authorities, others agitated for violent revolt, and still others sought accommodation---Jesus' call to love the neighbor was a call to restore the civic friendship necessary for any political program to succeed.

Even more radical, and more politically essential, was the command to ``love your enemies'' (Matthew 5:44).
This teaching is often spiritualized as a call to individual pacifism, but in the context of a movement aiming to unite the former Greek empire, it takes on concrete political significance.
The deepest fracture in the Hellenistic world was not between Greeks and Romans but between Greeks and Jews, between Jews and Samaritans, between Judeans and Galileans, between diaspora communities in Alexandria, Antioch, and Ephesus who had for generations been divided by ethnic and religious hostility.
Any serious attempt to restore the Kingdom of God to ``all the nations'' (πάντα τὰ ἔθνη)---that is, to the territories of the former Greek empire---would require bridging these internal divisions.

``Love your enemies'' does not mean surrender to Rome; it means reconciliation among the subjected peoples.
It means that the Greek in Antioch and the Jew in Jerusalem, the Samaritan and the Judean, the Egyptian and the Syrian must see each other not as rivals but as fellow citizens of the coming kingdom.
This was the revolutionary political program embedded in the ethical teaching: to create a unified political subject out of a fractured population.
...
The connection between moral reformation and political restoration was explicit in Jewish tradition.
The prophets repeatedly linked Israel's failure to uphold justice and righteousness with their loss of sovereignty, and promised that restoration would come only when the people returned to covenant faithfulness.
Isaiah 1:27 declares, ``Zion shall be redeemed by justice, and those in her who repent, by righteousness.''
Jeremiah 22:3-5 warns the kings of Judah: ``If you do not obey these words... this house shall become a desolation.''
The promise of restoration in the prophetic literature is always conditional on ethical transformation: the people must turn from injustice, greed, and idolatry before God will act to restore their kingdom.

Jesus' ethical demands fit precisely within this tradition.
When he teaches, ``Blessed are the merciful, for they shall obtain mercy'' (Matthew 5:7), ``Blessed are the peacemakers, for they shall be called sons of God'' (Matthew 5:9), or ``Forgive us our debts, as we also have forgiven our debtors'' (Matthew 6:12), he is not offering private spiritual consolation.
He is articulating the moral conditions necessary for the people to be worthy of God's kingdom.
A people characterized by mercy, peacemaking, and mutual forgiveness is a people prepared for restoration.
A people mired in vengeance, factionalism, and exploitation is not ready to receive sovereignty; they would only replicate the injustices that brought divine punishment in the first place.

This also explains why Jesus' harshest condemnations are reserved not for Roman occupiers but for the Jewish elite who exploited their own people.
The scribes and Pharisees who ``devour widows' houses'' (Mark 12:40), the temple authorities who turn the house of prayer into ``a den of robbers'' (Mark 11:17), the wealthy who store up treasures while ignoring the poor (Luke 12:16-21)---these are the internal moral failures that make the people unworthy of restoration.
The logic is the same as in the prophets: God will not restore sovereignty to a people whose leaders are unjust and whose society is characterized by oppression.
The prerequisite for political restoration is moral and civic reformation.

The love ethic is therefore not a retreat from politics but the foundation of the political program.
It is the answer to the question: how does a fragmented, demoralized, and morally compromised population become worthy of God's kingdom?
The answer is \textit{metanoia}---a collective turning toward justice, solidarity, and covenant faithfulness.
This turning is simultaneously spiritual (a reorientation toward God) and political (a rebuilding of the civic bonds necessary for collective action and divine favor).

When Jesus says, ``The Kingdom of God is within/among you'' (Luke 17:21), he is not offering a vague spiritual metaphor.
He is saying that the kingdom is not yet visible on the map, but it already exists in the transformed community, in the people who have undergone \textit{metanoia} and now embody the justice, mercy, and solidarity that characterize God's reign.
The kingdom is carried by its citizens; it survives not through military strength but through the moral and civic character of the people who pledge allegiance to it.

This is why the early Christian movement, despite facing persecution and political fragmentation, did not collapse but spread throughout the Greek-speaking East.
It offered not just a theology but a practical political program: rebuild civic trust, bridge ethnic and religious divisions, create communities characterized by justice and mutual aid, and declare daily allegiance to the coming empire of God.
When Constantine eventually consolidated the Eastern Roman Empire and declared Christianity the imperial religion, he was not inventing a new political theology; he was recognizing and institutionalizing the political reality that had been built from below by communities formed through Jesus' ethical and political teaching.

The love ethic, therefore, is not evidence against the political reading of Jesus' mission.
It is the mechanism through which the political program was to be realized.
