...
Luke 1:32--35 places these exact phrases in Gabriel's annunciation to Mary, demonstrating that the vocabulary already existed within Jewish messianic expectation shaped by Hellenistic royal precedent.
...
Walsh identifies a depiction of Jesus at a well using the same commanding stance as the Prima Porta Augustus, and other compositions show Christ flanked by stars in a manner that mirrors imperial Helios imagery such as that associated with Hadrian's mausoleum.
