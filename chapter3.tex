...
The early translations then record the ending growing member by member: the Curetonian Syriac keeps kingdom and glory, Codex Bobiensis power alone, the Sahidic Coptic power and might, until the Byzantine text settles on the full triplet with Amen \cite[on Matt.~6:13]{westcotthort:appendix}.
The first commentator to expound the full form is John Chrysostom, preaching at Antioch around 390 \cite[Homily 19]{chrysostom:hommatt}; every earlier exposition, Greek or Latin, lacks it \cite[on Matt.~6:13]{westcotthort:appendix}.
Three centuries of daily use pulled the full formula---kingdom, power, and glory---into the Gospel text.
The formula was royal before it was liturgical.
Daniel, composed under Seleucid rule, has the courtier tell the king of kings, ``the God of heaven hath given thee a kingdom, power, and strength, and glory'' (Daniel 2:37), and its night vision grants the one like a son of man ``dominion, and glory, and a kingdom\ldots{} an everlasting dominion'' (Daniel 7:14).
David's blessing claims the same set for God as king: ``thine, O Lord, is the greatness, and the power, and the glory\ldots{} thine is the kingdom'' (1 Chronicles 29:11).
The Ptolemaic chancery spoke the same vocabulary of a living king: the Rosetta Stone opens with Ptolemy V ``who has succeeded his father in the kingship,'' calls him ``most glorious'' and ``living for ever,'' and credits him as the one ``to whom the Sun has given victory'' (OGIS 90).
So the acclamation the congregations attached to the prayer spoke the standing language of kingship, attested before Jesus in 4 witnesses across court tale, throne vision, temple blessing, and royal decree---and handed all of it to God alone.
