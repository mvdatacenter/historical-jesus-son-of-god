...
By reference the picture is the same. No writer names Mark, Matthew or Luke before Irenaeus in about 180AD \cite[3.1.1]{irenaeus:advhaer}: the Mark and the Hebrew Matthew that Papias knew are not the Greek gospels, as discussed below \cite[3.39]{eusebius:he}, and Marcion's gospel is attested from 140AD, forty years earlier \cite{tertullian:marcionem}.
...
So the order of attestation is John first, then Marcion, then Judas, Truth and the Marcosian story named in the same breath as Mark, Matthew and Luke, with the copies of Thomas and Mary as old as the oldest copies of Mark and Luke: the three held to be the oldest have no witness, by copy or by name, older than the witnesses to the gospels later called heretical, and John precedes them all.
