...
The hand allows the early second century on every dating, and only the assumed date of John argues against its first decades, so this book takes the early second century as the most plausible date, with some room either way.
...
The copies and the references give the reverse of the order in which Irenaeus says the four were written, Matthew first, then Mark, then Luke, and John last \cite[3.1.1]{irenaeus:advhaer}: John is attested first and the three last.
...
A copy from the early second century and a quotation under Hadrian point the same way: John was an established book in Egypt in the first decades of the second century.
