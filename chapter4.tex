...
P52 is a small piece of John 18, and its date rests on its handwriting alone.
...
Within that range, this book takes about 125AD as the most plausible year, with some room either way.
...
By reference the order is the same.
...
What he meant by the Hebrew dialect is disputed.
Origen and Eusebius took it as the Hebrew language, and that is still the common reading \cite[3.24.6, 6.25.4]{eusebius:he}.
This book reads it as the Greek spoken by Greeks living in Judea or by Jews living in Greek lands, and makes that case in the discussion of Matthew below.
...
A copy made about 125AD and a quotation from the same decades point the same way: John was a well established book in Egypt from the very start of the second century, whatever uncertainty remains about the fragment's exact year.
