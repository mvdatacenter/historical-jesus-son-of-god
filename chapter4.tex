...
The Gospel of John explicitly categorizes John's baptism activity using the Greek term καθαρισμός (purification), not μετάνοια (repentance) or ἄφεσις (forgiveness).
In John 3:25, when a dispute arises about John's baptism, the text states it was περὶ καθαρισμοῦ—``concerning purification.''
This is the technical Greek term for ritual purification and consecration, the standard category for lustration before sacred office or sacred encounter in Greek religion.
It is not the language of moral repentance.
This lexical evidence alone undermines the common interpretation of John's baptism as primarily about repentance for sins.

Furthermore, the baptism narratives contain a fixed three-part structure that appears exclusively in ancient coronation rituals: (1) ritual washing, (2) divine anointing or bestowal of power, and (3) public proclamation of royal sonship.
This sequence is not found in repentance rites, prophetic commissioning, or any other religious ceremony of the period.
...
This three-part pattern is well-attested in Egyptian coronation rituals from Ptolemaic temples at Philae and Edfu, where Horus undergoes purification, receives divine investiture, and is proclaimed the rightful son and ruler.
The same structure appears in Near Eastern royal inscriptions, such as the Assyrian coronation texts of Sennacherib and Esarhaddon, which describe ritual purification, divine bestowal of kingship, and proclamation formulas declaring the king as chosen or beloved of the gods.
In the Hebrew Bible, David's anointing in 1 Samuel 16 follows the same pattern: a ritual act by a prophetic figure, the Spirit of the Lord rushing upon David, and his recognition as God's chosen.
Psalm 2:7, a royal enthronement psalm, provides the exact formula later echoed in the baptism accounts: ``You are my son; today I have begotten you.''

The coronation reading is further supported by internal narrative logic that contradicts the repentance interpretation.
In Matthew 3:14, John protests Jesus's baptism, saying ``I need to be baptized by you, and do you come to me?''
...
The coronation interpretation is strengthened further by early textual variants.
A well known earlier variant of the baptism quote is ``Today I have begotten you'' (Psalm 2:7).
The Gospel of the Hebrews preserves this reading, and it appears in some manuscripts of Luke as well.
This phrase is not just about divine sonship in a general sense—it is a Davidic enthronement formula spoken by God to the newly installed king of Israel.
In Second Temple Judaism, Psalm 2 was widely understood as Messianic, referring to the anointed one (Christos) who would rule the nations.
...
This variant was likely suppressed in later manuscripts when the understanding of Jesus shifted from a political to a primarily religious figure, much like references to the temple destruction and certain resurrection accounts were modified or removed.
