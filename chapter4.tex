...
By manuscript, John comes first: P52 is dated to about 125AD, plausibly even earlier to 100AD, and a second copy from Oxyrhynchus, P90, is also second century \cite{intf:liste}.
The earliest copies of the other three come later: Matthew has one second-century fragment, P104, Mark's oldest is P137 from the turn of the second and third centuries, and Luke has nothing before the third century \cite{intf:liste}.
Of the gospels outside the four, Thomas has a Greek copy from Oxyrhynchus written not much later than 200AD \cite{grenfell:logia}, and the Gospel of Mary has two Greek copies from the same town, P.Ryl.\ 463 from the early third century and P.Oxy.\ 3525 from the third \cite[pp.~12--13]{deboer:magdalene}, copies that put its writing in the second century, as shown below.
By reference the three come no earlier: the earliest possible notice of any of them is Papias's, and it reaches us only as Eusebius quotes it \cite[3.39]{eusebius:he}.
Papias says that Mark wrote down Peter's teaching and that Matthew composed the sayings ``in the Hebrew dialect'' \cite[3.39]{eusebius:he}.
This book reads that dialect as the Greek spoken by Greeks living in Judea or by Jews living in Greek lands, and argues it in the discussion of Matthew below; the more common reading, which Origen and Eusebius already give, takes the words to mean the Hebrew language \cite[3.24.6, 6.25.4]{eusebius:he}, and the question is far from settled.
Papias's own date is not recorded; it is inferred from Irenaeus, who calls him a hearer of John and a companion of Polycarp \cite[5.33.4]{irenaeus:advhaer}, and from Eusebius \cite[3.39]{eusebius:he}.
The dated notices come later: Marcion's gospel is attested from 140AD \cite{tertullian:marcionem}, and Luke is first named, and the three first named together, by Irenaeus in about 180AD \cite[3.1.1]{irenaeus:advhaer}.
Irenaeus names the three in the same work in which he names the Gospel of Judas of the Cainites \cite[1.31.1]{irenaeus:advhaer} and the Gospel of Truth of the Valentinians \cite[3.11.9]{irenaeus:advhaer}, retells from the Marcosians' writings the story of the boy Jesus and the alphabet that survives in the Infancy Gospel of Thomas \cite[1.20.1]{irenaeus:advhaer} \cite[6]{infancy:thomas}, and reports that each group holds to one gospel: the Ebionites Matthew, Marcion a cut-down Luke, those who separate Jesus from Christ Mark, and the Valentinians John \cite[3.11.7]{irenaeus:advhaer}; Thomas is named a generation later, by Origen \cite[1.2]{origen:homluke}.
So the order of attestation is John first, by the copies, which are objects in hand; Papias's possible notice of Mark and Matthew has no firm place in the order, since his date is inferred; then Marcion's gospel from 140AD; and only in 180AD Luke, the three named together, and Judas, Truth and the Marcosian story named in the same breath as them, with the copies of Thomas and Mary as old as the oldest copies of Mark and Luke.

John's lead among the manuscripts alone can be explained by the accident of history: most early sources were lost, and the oldest to survive happened to be John.
...
It is a small piece of one copy of John 18, so the book it was copied from is older than the fragment \cite{intf:liste}.
Its hand allows a date from the late first century into the second; the usual range of 125AD to 175AD takes its lower end from the assumed date of John, as the next chapter argues, so the hand alone puts a copy of John in Egypt somewhere in the second century, and possibly at its start \cite{nongbri:p52}.
A second witness stands beside the copy, dated by other means and independent of whatever the sand happened to spare: Basilides, whose teaching Clement of Alexandria places under Hadrian \cite[7.17]{clement:stromata}, quoted John in Alexandria, and Hippolytus, refuting him a century later, reports him citing ``He was the true light, which lights every man that comes into the world'' as ``that which has been stated in the Gospels'', and ``Mine hour is not yet come'' \cite[7.22, 7.27]{hippolytus:refutatio}.
So two independent witnesses, a copy dated by its hand and a quotation dated by Clement, put John in Egypt as an established book in the first decades of the second century, and its writing earlier still.
...
The only possible earlier references to Gospels are Papias \cite[3.39]{eusebius:he}, Polycarp \cite{polycarp:philippians} and Clement \cite{clement:firstclement}, who plausibly wrote before 140AD, and Basilides, whose teaching Clement of Alexandria places under Hadrian and on into the reign of Antoninus \cite[7.17]{clement:stromata}.
Papias's notice, set out above, is the one possible reference to Mark and Matthew from before 140AD, and it carries two doubts: his date is inferred, and his words reach us only through Eusebius, who calls him a man of very small intelligence \cite[3.39]{eusebius:he}.
Basilides's quotations of John 1:9 and John 2:4, set out above, are the one reference to John among the four, and John 1:9 is the evangelist's own sentence, not a saying of Jesus that oral tradition could have carried \cite[7.22, 7.27]{hippolytus:refutatio}.
