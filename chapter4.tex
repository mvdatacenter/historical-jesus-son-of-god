...
Papias's own date is not recorded; it is inferred from Irenaeus, who calls him a hearer of John and a companion of Polycarp \cite[5.33.4]{irenaeus:advhaer}, and from Eusebius \cite[3.39]{eusebius:he}, and Chapter~5 sets out the usual dating and argues that he fits the late first century as well.
...
Its exact findspot is unknown, but it is clearly Egyptian.
Its date rests on its handwriting: most plausibly about 125AD, with some uncertainty either way \cite{intf:liste}.
The handwriting alone allows a date in the late first or early second century; the usual range of 125AD to 175AD is fixed at its lower end by the assumption that John was written about 100AD to 110AD, as Section~\ref{subsec:regional-canon-before-universal} in the next chapter shows \cite{nongbri:p52}.
It is a small fragment of John 18, a piece of one copy, so the gospel it was copied from is older than the fragment \cite{intf:liste}.
The same chapter adds that John was already being quoted in doctrinal argument in Alexandria under Basilides: Hippolytus, refuting him, reports him quoting John 1:9 and John 2:4 \cite[7.22, 7.27]{hippolytus:refutatio}.
So while some uncertainty remains in the date, P52 is most likely a piece of a book already well established at the very start of the second century.
