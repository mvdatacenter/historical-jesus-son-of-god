...
The hand allows anything from the late first century to 175AD; the editions print 125AD to 175AD, and their floor comes from the assumed date of John rather than from the papyrus, so the earlier date stays open \cite{nongbri:p52}.
This book takes 125AD, the early end of the printed range, as the most likely date, since the quotation in the next paragraph shows John in use in Alexandria under Hadrian, and every witness that follows stands at its most likely date in the same way.
