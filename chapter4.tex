...
\subsection{Synoptic Gospels}\label{subsec:synoptic-gospels}
...
\subparagraph*{Egyptian background (pharaonic accession).}
...
\subparagraph*{Hellenistic and Persian accession practice.}
