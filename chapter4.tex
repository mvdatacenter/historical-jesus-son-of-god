...
Of the gospels outside the four, Thomas has a Greek copy from Oxyrhynchus written not much later than 200AD \cite{grenfell:logia}, and the two Greek copies of the Gospel of Mary, P.Ryl.\ 463 and P.Oxy.\ 3525, are early third century \cite[pp.~12--13]{deboer:magdalene}.
By reference the picture differs, and is taken up below: Papias names a Mark and a Matthew in the Hebrew dialect \cite[3.39]{eusebius:he}, Marcion's gospel is attested from 140AD \cite{tertullian:marcionem}, Irenaeus in 180AD names the four together with gospels he deems heretical, among them a Gospel of Judas \cite[1.31.1; 3.11.8]{irenaeus:advhaer}, and Thomas is named by Origen \cite[1.2]{origen:homluke}.
The Gospel of Mary has no external date: its two Greek copies put its composition before the third century, and every narrower date in the literature is argued from its contents \cite{janz:evmar}.
The later dates rest on the text's ideas: the middle of the century is argued from its closeness to Middle Platonist thought, and the second half from its taking up of ideas called gnostic \cite{janz:evmar}, or from a supposed dependence on the canonical gospels, although the sayings it shares with them are as well explained by a common tradition \cite[p.~14]{deboer:magdalene}.
Each of these dates the text by when its ideas are assumed to have arisen, not by anything in it that names a time.
The early date is argued from the dispute the text stages, a conflict over a woman's authority to teach between groups later sorted as orthodox and heretical, shown at an early stage with both sides still seeking agreement \cite{janz:evmar}.
Copies made at Oxyrhynchus by the early third century leave the Gospel of Mary a second-century text either way, with the first half of the century fitting the evidence slightly better \cite{janz:evmar}.
