...
None of the authors explicitly identify themselves within the text; all four gospel manuscripts are anonymous.
The names Matthew, Mark, Luke, and John as gospel authors first appear together in Irenaeus \cite[3.1.1]{irenaeus:haereses}, writing around 185~AD.
Irenaeus relies partly on Papias of Hierapolis \cite[3.39]{eusebius:he}, whom Eusebius himself deems unreliable: ``a man of very small intelligence, as is clear from his books'' (\emph{Historia Ecclesiastica}~3.39.13).
The entire four-name attribution scheme thus rests on a single late second-century witness citing a source his own tradition considered dubious.
...
The literary link between the Lazarus narrative and the resurrection encounter is tighter than thematic resemblance.
At least seven verse-level parallels run between John~11 and John~20: a stone removed or commanded moved (11:39; 20:1), Mary weeping at the scene (11:33; 20:11), the question ``where have you laid him?'' (11:34; 20:15), attention to burial cloths (11:44; 20:6--7), a personal-name summons as the turning point (11:43 ``Lazarus!''; 20:16 ``Mary!''), a release-or-retention command (11:44 ``loose him, let him go''; 20:17 ``do not hold on to me''), and an immediate report to others (11:45--46; 20:18).
This density of structural repetition indicates deliberate compositional design, not coincidence---the same eyewitness voice shapes both scenes.
...
The fulfillment quotations also settle a longstanding question about the gospel's original language.
Papias's claim that Matthew ``composed the sayings in the Hebrew dialect'' (\cite[3.39]{eusebius:he}) has led some to assume an original Hebrew or Aramaic text later translated into Greek.
The text itself refutes this.
Matthew 1:23 quotes Isaiah 7:14 to establish that Jesus's birth fulfills prophecy, but the argument depends entirely on the Septuagint's rendering of the Hebrew \emph{almah} (עַלְמָה, ``young woman'') as \emph{parthenos} (παρθένος, ``virgin'').
In the Hebrew original the verse says nothing about virginity; the ``virgin birth'' proof-text only works in Greek.
An author translating from a Hebrew source would have had the Hebrew Isaiah in front of him and would have noticed the discrepancy.
Matthew's most theologically pivotal fulfillment quotation is built on the Greek Septuagint, not the Hebrew Bible---the gospel was composed in Greek from the start.
