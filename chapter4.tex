...
By reference the picture is the same: the earliest notice of any of the three is Papias, quoted by Eusebius, who describes Mark writing down Peter's teaching and Matthew composing the sayings in the Hebrew dialect, the Greek spoken by Greeks living in Judea or by Jews living in Greek lands, as discussed below \cite[3.39]{eusebius:he}; Marcion's gospel is attested from 140AD \cite{tertullian:marcionem}; and Luke is first named, and the three first named together, by Irenaeus in about 180AD \cite[3.1.1]{irenaeus:advhaer}.
...
So the order of attestation is John first, by the copies; then, within the following decades, Papias's notice of Mark and Matthew and Marcion's gospel; and only in 180AD Luke, the three named together, and Judas, Truth and the Marcosian story named in the same breath as them, with the copies of Thomas and Mary as old as the oldest copies of Mark and Luke.
...
In case of Papias, he describes Mark writing down Peter's teaching and Matthew composing the sayings in the Hebrew dialect, the Greek spoken by Greeks living in Judea or by Jews living in Greek lands, as the discussion of Matthew below shows, so his notice is the earliest reference to two of the four.
