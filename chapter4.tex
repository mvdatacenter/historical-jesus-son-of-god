...
The hand allows anything from the late first century to 175AD; the editions print 125AD to 175AD, and the floor of that range comes from the assumed date of John rather than from the papyrus \cite{nongbri:p52}.
This book takes 125AD as the most likely date within that range, and the witnesses below stand in the same order, each at its most likely date.
...
The three are first named together by Irenaeus, at about 180AD \cite[3.1.1]{irenaeus:advhaer}.
