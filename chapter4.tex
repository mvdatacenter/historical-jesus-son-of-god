...
Mark is known to have an edition without the resurrection: both Codex Vaticanus and Codex Sinaiticus, the two oldest major Greek uncials (4th century), end at Mark 16:8 with the women fleeing the empty tomb in fear and saying nothing.
Vaticanus leaves a conspicuous blank column after 16:8---the only such gap in its New Testament portion---before continuing with Luke, suggesting the scribe knew of additional material but chose not to include it.
Three alternative endings were later added by other scribes who considered the abrupt stop unacceptable---a shorter conclusion, the familiar longer ending (16:9--20), and a combined version.
The existence of three independent scribal attempts to ``fix'' the same passage is direct evidence that the gospels were actively edited by later hands.
...
By attested, we have a papyrus P52 of John, which is dated to 125AD, plausibly even earlier to 100AD \cite{nongbri:p52}.
It is a fragment of John 18 written on both sides, a leaf from a codex of the whole gospel, so what was being copied in Egypt by then was a finished book \cite{intf:liste}.
The hand does not fix a year: its first editor placed it in the first half of the second century, the editions print 125AD to 175AD, and the closest dated parallels run from the late first century onward \cite{nongbri:p52}.
We do not know the year; we expect it between 100AD and 150AD, and nothing in that spread favours one end, so the middle, 125AD, is the most likely single date, and almost certainly not the exact one.
Every witness that follows is dated the same way, at its most likely year with the uncertainty around it, and the order of attestation is the order of those most likely years.
The next witness is Papias, most likely about 130AD, and what he attests is Mark.
As Eusebius quotes him, he reports what the elder used to say: that Mark wrote down Peter's teaching \cite[3.39]{eusebius:he}.
He gives this as tradition received, not as news, so Mark carried authority in his circle for some time before he wrote.
No ancient writer dates Papias; his date is inferred from Irenaeus, who calls him a hearer of John and a companion of Polycarp, and his words reach us only through Eusebius, so his notice stays a possible reference and nothing firmer \cite[5.33.4]{irenaeus:advhaer}.
He also says that Matthew composed the sayings ``in the Hebrew dialect'' \cite[3.39]{eusebius:he}.
Origen, Eusebius and Jerome took this as the Hebrew language \cite[3.24.6, 6.25.4]{eusebius:he} \cite[preface]{jerome:matthew}.
This book reads it as the Greek spoken by Greeks living in Judea and by Jews living in Greek lands, the Greek of the Matthew we have, and makes that case in the discussion of Matthew below.
The next witness is Marcion, at 140AD: the oldest mention of him is Tertullian's, and Tertullian gives credible attestation of his gospel at that date \cite{tertullian:marcionem}.
Mark, Matthew and Luke are first named together by Irenaeus, at about 180AD \cite[3.1.1]{irenaeus:advhaer}.
He names them in the same work as the Gospel of Judas \cite[1.31.1]{irenaeus:advhaer} and the Gospel of Truth \cite[3.11.9]{irenaeus:advhaer}.
From the writings of the Marcosians he retells the story of the boy Jesus and the alphabet, the story that stands in the Infancy Gospel of Thomas \cite[1.20.1]{irenaeus:advhaer} \cite[6]{infancy:thomas}.
He also reports that each group held to one gospel: the Ebionites Matthew, Marcion a cut-down Luke, those who separate Jesus from Christ Mark, and the Valentinians John \cite[3.11.7]{irenaeus:advhaer}.
So the first writer to name the three names them beside the gospels he condemns, and as books that rival groups each held to.
Thomas is named a generation later, by Origen \cite[1.2]{origen:homluke}.
The copies run the same way as the references.
John has a second copy from the second century, P90 from Oxyrhynchus \cite{intf:liste}.
Matthew has one fragment from the second century, P104; the oldest Mark, P137, is from about 200AD; and Luke has no copy before the third century \cite{intf:liste}.
Thomas and Mary are copied as early as Mark and Luke: a Greek Thomas from Oxyrhynchus written not much later than 200AD \cite{grenfell:logia}, and two Greek copies of Mary from the same town, P.Ryl.\ 463 from the early third century and P.Oxy.\ 3525 from the third \cite[pp.~12--13]{deboer:magdalene}.
So, by copy and by report, ordered by most likely date, the attestation runs: John at 125AD; Mark, and on this book's reading Matthew, through Papias at about 130AD; Marcion's gospel at 140AD; and the three together only with Irenaeus at 180AD, beside Judas, Truth and the Marcosian story, with Thomas and Mary copied as early as Mark and Luke.
Irenaeus gives the order of writing as Matthew, Mark, Luke and John \cite[3.1.1]{irenaeus:advhaer}; John, the last in his order, is the first attested.
...
Its exact findspot is unknown, but it is clearly Egyptian \cite{nongbri:p52}.
A second witness does not depend on which papyri happened to survive.
Basilides taught at Alexandria \cite[1.24.1]{irenaeus:advhaer}, and Clement of Alexandria places him under Hadrian and on into the reign of Antoninus \cite[7.17]{clement:stromata}.
Hippolytus, refuting him, reports him quoting ``He was the true light, which lights every man that comes into the world'' as what ``has been stated in the Gospels'', and also ``Mine hour is not yet come'' \cite[7.22, 7.27]{hippolytus:refutatio}.
The first is John 1:9, the evangelist's own sentence and not a saying of Jesus, so the quotation comes from the book itself.
A teacher who cites a book as the Gospels in a doctrinal dispute is using a book his hearers already accept, so under Hadrian, in the first decades of the second century, John already carried authority in Alexandria.
A codex leaf from about 125AD and a quotation under Hadrian point the same way: John was an established book in Egypt in the first decades of the second century, and had been in circulation for some time before.
...
The only possible earlier references to Gospels are Papias \cite[3.39]{eusebius:he}, Polycarp \cite{polycarp:philippians} and Clement \cite{clement:firstclement}, who plausibly wrote before 140AD, and Basilides, whose quotation of the evangelist's own words under Hadrian is given above.
...
The next reference is Justin Martyr \cite{justinmartyr:trypho}, and he again is most likely quoting the Gospel of John, notably not any quote of Jesus recorded in the Gospel of John, but a known fragment of John.

Then the later references from Tertullian \cite{tertullian:marcionem}, Irenaeus \cite{irenaeus:advhaer}, and Origen \cite{origen:contracels} all contain unambiguous references to all the canonical gospels as already mature and wide-spread texts, but at this point we are already in the year 180AD and later.
...
While Eusebius attributes the Book of Revelation to John \cite[3.39]{eusebius:he}, the same analysis shows the author of the gospel of John most definitely not the author of the Book of Revelation.
...
The Pool of Siloam (John 9:7) was excavated in 2004 and confirmed as a massive Second Temple period ritual pool (excavated by R.~Reich and E.~Shukron, 2004).
John alone identifies Annas and Caiaphas as functioning together in the high priesthood during Jesus' trial (John 18:13--24), whereas the Synoptics name only Caiaphas.
Josephus confirms this political reality: although Caiaphas held the formal office, Annas retained decisive influence after his deposition \cite[18.26; 18.34--35]{josephus:ant}.
This is institutional knowledge of Jerusalem's ruling structure, not merely geographic detail, and it matches the documented power dynamics of the period.
The Caiaphas family tomb discovered in 1990 and excavated by Zvi Greenhut contained a Greek obol placed in the mouth of one individual.
This coin was the payment for Charon's ferry, a standard Greek funerary custom.
The high priestly household adopted Hellenistic burial practice at the highest level of the Temple elite.
...
The Gospel of Mary is not a late curiosity from the margin.
Two Greek copies of it survive from Oxyrhynchus alone, both of the third century, in two different book forms and two different hands: a leaf of a small codex (P.Rylands 463, early third century) and a roll (P.Oxyrhynchus 3525), and their surviving portions do not overlap; the complete text is a Coptic translation in the Berlin Codex (Papyrus Berolinensis 8502, fourth or fifth century), bound with the Apocryphon of John.
At the same town, in the same two centuries, by the dates of the Münster register of New Testament manuscripts \cite{intf:liste}, Mark survives in one copy (P.Oxyrhynchus 5345), Thomas in three (P.Oxyrhynchus 1, 654, 655), Luke in four (P.Oxyrhynchus 2383, 4495, 5346, 5478), Matthew in five (P.Oxyrhynchus 2, 2683 with 4405, 4401, 4403, 4404), and John in eleven (P.Oxyrhynchus 208 with 1781, 1228, 1596, 1780, 3523, 4445, 4446, 4447, 4448, 4803, 4805).
A gospel copied at one provincial Egyptian town as often as Mark, in codex and in roll, and then translated into Coptic, was in circulation, and a text already copied twice there by the early third century was written in the second.
What survives is about half of it: pages 1--6 and 11--14 of the Berlin Codex are lost, and with them the opening, where a text says who its speaker is.
What the surviving pages give her is precedence, not pedigree: Peter grants that ``the Savior loved you more than the rest of women'' (Coptic 10), and the quarrel that follows turns on that precedence.
...
The Gospel of Philip (63:32--36) preserves another version: ``The companion of the [Savior is] Mary Magdalene. [He loved] her more than [all] the disciples, and used to kiss her often on [the\ldots].''
The word behind ``companion'' is κοινωνός, which the Greek Bible uses for a wife: ``she is your κοινωνός and the wife of your covenant'' (Mal 2:14 LXX).
In \emph{Pistis Sophia} (Books 1--3), Mary asks thirty-nine of the sixty-four questions; Jesus calls her ``blessed,'' ``more blessed than all women on earth''---and Peter complains that she will not stop talking; the same book seats her and John the virgin at the Savior's right and left, above all the disciples (ch. 96).
...
The identification with John son of Zebedee does not come from the text itself but from Irenaeus \cite[3.1.1]{irenaeus:advhaer}, writing around 185~AD, who relies partly on Papias of Hierapolis \cite[3.39]{eusebius:he}, whom Eusebius himself describes as ``a man of very small intelligence, as is clear from his books'' (\emph{Historia Ecclesiastica}~3.39.13).
The named attribution rests on a late and contested chain of testimony, not on anything the Gospel says about its own author.
...
In Gospel of Mary, Gospel of Thomas, and Pistis Sophia it is always Peter who attacks Mary because she is a woman and because she received special revelation \cite{deboer:magdalene}.
...
John 20:11--18 follows the narrative pattern of a Hellenistic romance.
The separated lovers, the mistaken identity when Mary assumes Jesus is the gardener, and the recognition scene match the conventions of Greek romantic fiction.
This genre was associated with female readership and authorship, and the narrative grammar is Greek romance rather than Jewish apocalyptic.
...
The closest chronological parallel is the diary of Vibia Perpetua (c.~203~AD), a wealthy educated woman who recorded her own visions, family conflict, and legal vulnerability under state persecution in extended first-person prose.
The text survives inside a composite document where a male editor's frame is visibly distinct from her ``I''-voice---ancient redaction acting on a woman's self-narration, observable in the manuscript rather than hypothetical.
Perpetua demonstrates what the papyri and lyric fragments cannot: that a woman's sustained theological prose could survive antiquity, even when embedded in a male editorial structure.
...
The link between the Lazarus narrative and the resurrection encounter is not thematic resemblance but scene-structure.
John~11 and John~20 share the same physical sequence: a stone that must be moved (11:39; 20:1), Mary weeping at the site (11:33; 20:11), the same question about the body's location (11:34; 20:15), deliberate attention to burial cloths (11:44; 20:6--7), a personal-name summons as the turning point (11:43 ``Lazarus!''; 20:16 ``Mary!''), a command governing bodily contact and release (11:44 ``loose him, let him go''; 20:17 ``do not hold on to me''), and an immediate report to others (11:45--46; 20:18).
This repetition is not doctrine mirroring doctrine or symbol echoing symbol, but stones, cloths, tears, body placement, and tactile prohibitions arranged in the same order.
A desk-writer building theology reaches for titles, proof-texts, and programmatic speeches, not for the remembered mechanics of moving stone, unbinding cloth, and controlling touch at the moment of recognition.
Both scenes are also private in access and scale: Lazarus's death and raising is a household event in Bethany, and the resurrection encounter is a solitary garden scene known through Mary alone.
The simplest chain of facts is that the same narrative hand shaped both accounts because the same memory carried both sequences.
The witness with access to a Bethany family death and to the private Easter morning encounter belongs to the Bethany circle, not to a distant compiler.

\subsection{Egyptian Transformation-Theology in the Resurrection Scenes}\label{subsec:egyptian-transformation-theology}

The Lazarus scene is a necromantic call delivered at the tomb mouth.
Jesus stands before the sealed chamber and calls the dead by name, and the corpse comes out bound and must be unbound, John 11:39--44.
The four-day detail fixes the condition as fully dead and beyond recovery, ``by this time he stinketh,'' John 11:39.
The same sequence appears in Egyptian material transmitted in Greek and demotic.
PGM IV.2125--2139 gives the formula ``Awake, awake, rise up, soul,'' spoken to a corpse in an Egyptian corpus written in Greek.
Apuleius, Metamorphoses 2.28--30, has the Egyptian \emph{propheta} Zatchlas call a corpse to speech at the bier.
Lucian, Philopseudes 13--14, describes an Egyptian-trained operator who raises a body and makes it speak.
The Setne Khamwas cycle preserves a tomb encounter in which Naneferkaptah's ghost speaks at length from within his burial place.
The indigenous form is the opening-of-the-mouth rite, which restores breath and speech to the dead at the tomb.

The Magdalene scene repeats the same structure in a second key.
A woman comes at dawn seeking the body of her lord, finds it gone, and questions a gardener who is the lord himself, John 20:1--17.
Plutarch, De Iside et Osiride 65--66, gives the Isis pattern: the goddess searches for the body of Osiris and finds him in the funerary landscape.
Osiris as Khentamenti is lord of the western necropolis, and the mortuary garden is his domain.
The form survives intact when the names change.
``Do not touch me, for I have not yet ascended,'' John 20:17, marks a liminal interval.
Egyptian texts require a protected transition while the \emph{ba} unites with the \emph{ḫat}, Book of the Dead Spells 23 and 89.
Premature contact disrupts the transformation, so touch is controlled until the process completes.

The sequence closes with animation transmitted by breath.
``He breathed on them, and saith unto them, Receive ye the Holy Spirit,'' John 20:22, uses \emph{enephusēsen} (ἐνεφύσησεν).
The gesture matches Egyptian iconography of the breath of life, where a deity places the \emph{ankh} at the nostrils of the deceased to impart life.
The opening-of-the-mouth rite uses breath to activate the body and restore the senses.
These scenes are absent from the Synoptics or altered away from this frame.
Luke inserts a denial, ``a spirit hath not flesh and bones,'' Luke 24:39, because his audience reads the appearances as phantasmal.
John makes no such denial because the \emph{ba} is the mechanism of resurrection, not a rival to it.
The Lazarus call, the garden recognition, the touch prohibition, and the breath transmission form one sequence of Egyptian transformation delivered in Greek.
...
Manuscript analysis \cite{schrader:martha} of over 250 transcriptions and manuscripts of the Gospel of John reveals systematic textual instability in the Mary/Martha passages of John 11--12.
One in five Greek manuscripts and one in three Old Latin manuscripts contain alterations around the Martha figure---a rate far too high to be accidental.
Early manuscripts including P66 and P75 show the names ``Mary'' and ``Martha'' shifting positions, with ``Mary'' appearing where later manuscripts read ``Martha,'' or the two being swapped entirely.
...
Tertullian \cite{tertullian:praxean}, one of the earliest church fathers to comment on this scene, attributes the confession to Mary in every surviving copy of his text---a patristic witness confirming what the manuscript variants already suggest.

The conclusion is straightforward: the textual evidence is consistent with the hypothesis that an original single strong female confessor named Mary in John 11 was later split into two figures and partially toned down, probably to reduce the prominence of that Mary.
...
The Gospel of Mary, copied at Oxyrhynchus in the third century as often as Mark, has her hold the Savior's teaching when the others weep, and turn them back to their work (Coptic 9); it records her leadership rather than suggesting it.
...
Sepphoris was destroyed by the Roman army around 4 BCE (Josephus, \emph{Antiquities} 17.271, 289) and rebuilt during Jesus' youth; as a τέκτων in nearby Nazareth, Jesus likely lived near this major reconstruction activity.
...
Clement of Alexandria, writing around 200 AD, openly compared Jesus with Dionysus and argued that Christ surpassed him in truth and power.
He did not deny the parallel but engaged it directly within a shared symbolic framework.
This patristic witness confirms that early Christian thinkers themselves recognized the Dionysian pattern surrounding wine, divine sonship, and sacred feast.
The earliest stratum of John reads as a ``Dionysian Gospel'' built on deliberate imitation of Euripides' Bacchae.
The Cana miracle, where water becomes wine, reproduces the signature act of Dionysus and functions as an explicit literary marker.
The imprisoned disciples freed by earthquake in Acts parallel the Bacchae's imprisoned Dionysus shaking loose his prison, and the ``I am the true vine'' discourse maps onto Dionysus's core symbol.
These markers cluster in identifiable layers: a Dionysian foundation, a later anti-Jewish polemical expansion, and finally the Beloved Disciple editorial frame.

Even if we discount synoptic gospels and the letter to Corinthians, the Didache \cite{didache}, a very early Christian text, also mentions the Eucharist as a well-established tradition.
...
Justin Martyr accuses followers of Mithras of copying Christian rites, which he attributes to demonic imitation \cite[66]{justinmartyr:apology}.
...
By the mid-2nd century, critics like Celsus \cite{origen:contracels} and Jewish polemicists engaged Johannine themes without claiming the gospel was a recent invention.
...
Polycarp \cite{polycarp:philippians}, active around 90AD, knew John's community, and Irenaeus explicitly testifies to Johannine authorship \cite[3.1.1]{irenaeus:advhaer}.
...
Modern scholarship has wrestled with how to characterize this relationship.
The case that John draws heavily on the Logos-doctrine of Hellenistic Judaism, with Philo the clearest witness, was made early and has never been refuted \cite{dodd:fourthgospel}.
John and Philo are ``two riffs on one Logos'': they share the same conceptual framework, with John's unique note being incarnation \cite{attridge:essays}.
Both read Exodus traditions---the manna, the tabernacle---through Logos-centered exegesis, making their overlap too specific to be coincidence \cite{borgen:philo}.
More cautious readings concede that Philo's Logos provided one strand of the background, alongside Jewish \emph{Memra} and Wisdom traditions \cite{brown:johannine}.
Later Christians freely drew on Philo, though direct dependence in John cannot be demonstrated beyond doubt \cite{runia:philo}.
A Jewish-centered counter-reading treats John's Prologue as a midrash on the \emph{Memra} within Second-Temple Judaism's binitarian monotheism, with or without Philo \cite{boyarin:jewishgospels}.
...
The strongest conclusion presses further: Philo's Logos-theology is itself already Christological, anticipating the categories John later applies to Jesus \cite{hillar:logos}.
...
The same narrative restraint appears in John 20:1--10, which reports only what the witnesses saw: the empty tomb, the linen wrappings lying there, and the face cloth folded separately.
It omits earthquakes, descending angels, and collapsing guards, and records observation rather than embellishment, the pattern expected from an eyewitness account.
...
Adding to this, the journey of Caspar, Melchior, and Balthazar in 7BC would make no sense, as the Greek throne was still held by Strato II Soter and his kingdom was not at the brink of collapse just yet.
...
We know Josephus placed the death of Herod the Great at the lunar eclipse just before the Passover \cite[17.167]{josephus:ant}.
...
The only possible dates for the lunar eclipse that happened close to 10 Nisan between 4pm UTC and 4am UTC, so could have been seen by the people in Jerusalem is: 0012 Apr 24--22:38:24 10410 -24585 41 N -a 1.4693 0.1335 -0.8101 96.4 - - 11S 64E (data from F.~Espenak and J.~Meeus, \emph{Five Millennium Canon of Lunar Eclipses}, NASA TP-2009-214172).
...
Josephus also quite clearly states that Archelaus ruled while Herod the Great was still alive \cite[17.229--249]{josephus:ant}.
...
The word ἁμαρτία, typically rendered ``sin,'' derives from a verb meaning ``to miss the mark'' or ``to err''---Aristotle's \textit{hamartia} in tragedy \cite[1453a]{aristotle:poetics} refers to a tragic error or misjudgment, not inherent moral evil.
...
The same pattern extends to the vocabulary of love in the Gospel of John.
In Gospel of John 13:34, the command ἀγαπᾶτε ἀλλήλους is not a call to sentiment but to mutual alignment and enacted commitment within the group.
This is not an instruction to feel affection but to maintain coordinated loyalty.
The same verb appears in John 14:15, where ἀγαπᾶτε is explicitly tied to obedience: ``If you ἀγαπᾶτε me, keep my commandments.''
This defines ἀγαπάω as actionable allegiance rather than internal emotion.
By contrast, φιλέω appears in contexts of personal closeness, as in John 11:3, ``ὃν φιλεῖς,'' referring to Jesus' attachment to Lazarus.
The distinction is therefore functional: ἀγαπάω governs structure, φιλέω describes relationship.
This difference is dramatized in John 21:15--17, where Jesus asks Σίμων, ἀγαπᾷς με, and Peter answers with φιλῶ σε.
The mismatch is repeated twice, showing Peter's refusal or inability to claim full alignment.
Only in the third question does Jesus shift to φιλεῖς με, accepting Peter's stated level.
The passage records a gap between commitment to a cause and attachment to a person.
Standard translations obscure this by rendering both verbs as ``love,'' flattening a structural distinction into a psychological one.
Once restored, the central Johannine command is no longer emotional but organizational.
The command is not ``feel love for one another,'' but ``stand with one another, support one another, maintain alignment within the group.''
The vocabulary of ἀγαπάω therefore belongs to the same political and structural register as μετάνοια, ἄφεσις, and πίστις.
...
Josephus records that Herod Antipas later arrested and executed John because he feared his political influence over the crowds \cite[18.116--119]{josephus:ant}, which explains why John first operated beyond Antipas's immediate jurisdiction.
The Transjordan location was a strategic base outside easy Herodian control yet close enough to draw Judean and Galilean followers.
...
The Gospel of the Hebrews \cite{gospelhebrews} and some manuscripts of Luke read ``Today I have begotten you'' at the baptism, quoting Psalm 2:7 directly rather than the softer ``This is my beloved Son.''
...
When he cites Isaiah 40:3 --- "a voice of one calling in the wilderness, 'Prepare the way for the Lord, make straight paths for him'" --- John functions as a royal herald, announcing the entry of the king rather than offering detached prophetic proof.
...
The same coronation sequence appears in Matthew, Luke, and John, but modern layout splits it into artificial preaching, baptism, and transition scenes.
Luke makes the coronation logic explicit by placing Jesus's genealogy at the baptism rather than at the birth, announcing royal lineage at the moment of investiture (Luke 3:23--38).
Modern readers therefore miss that all four gospels preserve a single, continuous coronation narrative.
...
Herodotus describes doves as the founding messenger-vehicle of Zeus's oracle at Dodona \cite[2.55--57]{herodotus:histories}, one of the oldest and most famous sanctuaries in the Greek world.
Hesiod (\emph{Fragments} 240 M--W) likewise places doves at Dodona's sacred oak, and the priestesses themselves were called Peleiades ("doves").
Homer \cite[16.233]{homer:iliad} and Plato (\emph{Phaedrus} 275b) both treat Dodona as a Zeus site where the god's will is delivered as speech from the oak.
...
Augustan inscriptions (OGIS 458, the Priene calendar) hailed the emperor as ``Savior'' and Ptolemaic decrees (OGIS 90, the Rosetta Stone) praised the king as ``God Manifest''---both using magnification formulas almost identical in tone to the Magnificat.
...
Inscriptions from the reigns of Augustus and Nero praise the emperor precisely for "casting down the arrogant, lifting up the humble, and filling the hungry with bread" (cf.~the Priene calendar inscription, OGIS 458; and Nero-era acclamations in IG II\textsuperscript{2} 3277).
...
The Gospel of the Hebrews \cite{gospelhebrews} uniquely calls the Holy Spirit Jesus's ``Mother,'' and she lifts him up by his hair and carries him to Mount Tabor.
...
The visit of the Magi has been universally accepted as an allegory but as shown in Section~\ref{sec:magi-court-protocol}, the titles of the Magi are exceedingly hard to fabricate by even the most knowledgeable of scholars in the Roman empire that were not greek empire loyalists.
...
Examples of this polarity and accession rite pattern are visible already in the Pyramid Texts \cite{pyramidtexts} and Coffin Texts \cite{coffintexts}, and in temple programs at Karnak, Luxor, and Medinet Habu, culminating in the Edfu cycle known as the "coronation of the falcon."
...
Cyrus is recognized through proved nobility after humble upbringing \cite[1.114--122]{herodotus:histories} \cite[1.3--4]{xenophon:cyropaedia}.
...
Papias reports that Matthew composed the sayings ``in the Hebrew dialect,'' and that each interpreted them as he was able (\cite[3.39]{eusebius:he}).
This statement has been read as if Matthew were first written in Hebrew or Aramaic and only later translated into Greek.
The text itself contradicts that assumption.
Matthew is composed in Greek saturated with Hebraisms and structured around fulfillment formulas drawn from Israel's scriptures---a Hebrew dialect of Greek, not a Semitic original.
The text casually uses Semitic terms a Greek from Athens would not understand but a Greek living in Israel would use daily: \emph{raka} (ῥακά, ``empty one,'' 5:22), \emph{mammonas} (μαμωνᾶς, ``wealth,'' 6:24), \emph{Gehenna} (γέεννα, the Valley of Hinnom, 5:22), \emph{Beelzeboul} (Βεελζεβούλ, a Semitic divine name, 10:25), and \emph{Emmanouel} (Ἐμμανουήλ, 1:23).
Matthew 1:23 cites Isaiah 7:14 using the Septuagint wording, where Hebrew \emph{almah} (עַלְמָה, ``young woman'') becomes Greek \emph{parthenos} (παρθένος, ``virgin''), and the argument for a virgin birth depends entirely on that Greek rendering.
The Hebrew text of Isaiah does not specify virginity, and a writer working from a Hebrew source would have seen the difference immediately.
The proof-text functions only in Greek, and the narrative is built around that Greek wording.
Matthew was composed in Greek from the start, and Papias was correct that it was written in a Hebrew dialect---but that dialect was Greek shaped by scripture.
...
The gospel associated with Marcion (c. 140AD) survives only through hostile witnesses such as Tertullian \cite{tertullian:marcionem}, Epiphanius \cite[42]{epiphanius:panarion}, and the \emph{Dialogue of Adamantius} (late 3rd/early 4th century).
...
But the alternative --- first argued in \cite{harnack:marcion} and since developed by subsequent textual analysis --- is that Marcion's gospel reflects an earlier edition of Luke.
...
The original case has been revisited and strengthened by subsequent textual analysis, and the theory of Marcionite priority remains a serious position in the field.
...
The common formula in works by historians like Herodotus \cite{herodotus:histories} and Thucydides \cite{thucydides:peloponnesian} begins with a clear intention to provide a factual account and a claim of reliable sources.
...
Like Polybius \cite{polybius:histories}, who uses the actions of local leaders as windows into the larger workings of an empire, Luke does the same.
