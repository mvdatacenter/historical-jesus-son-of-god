...
Ptolemaic decrees (OGIS 90, the Rosetta Stone) hailed the monarch as ``Theos Epiphanes'' (God Manifest), and Augustan inscriptions (OGIS 458, the Priene calendar) proclaimed the emperor as ``Savior,'' both using magnification formulas almost identical in tone.
