...
By reference the three come no earlier: the earliest possible notice of any of them is Papias's, and it reaches us only as Eusebius quotes it.
...
This book reads that dialect as the Greek spoken by Greeks living in Judea or by Jews living in Greek lands, and argues it in the discussion of Matthew below; the more common reading takes the words to mean the Hebrew language, and the question is far from settled.
...
Its date rests on its handwriting: most plausibly about 125AD, with some uncertainty either way.
...
It is a small fragment of John 18, a piece of one copy, so the gospel it was copied from is older than the fragment.
...
The only possible earlier references to Gospels are Papias \cite[3.39]{eusebius:he}, Polycarp \cite{polycarp:philippians} and Clement \cite{clement:firstclement}, who plausibly wrote before 140AD.
