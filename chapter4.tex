...
The strongest biblical parallel is 1 Peter 3:20: εἰς ἣν \ldots{} ὀκτὼ ψυχαί (``in which \ldots{} eight souls were saved'').
Here ψυχή is feminine, so the pronoun ἣν must be feminine.
One of these ψυχαί is Noah---an unambiguously male person.
The grammar is feminine because the noun is feminine, not because Noah is female.
