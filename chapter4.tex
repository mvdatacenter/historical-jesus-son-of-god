...
By manuscript, John comes first.
P52 is a small piece of John 18, and its date rests on its handwriting alone \cite{intf:liste}.
The usual dating is 125AD to 175AD \cite{nongbri:p52}.
The hand itself allows the late first century as well, and the floor of 125AD comes from the assumed date of John rather than from the papyrus, an assumption the next chapter examines \cite{nongbri:p52}.
Its first editor placed the hand in the first half of the second century \cite{nongbri:p52}.
This book takes about 125AD, where that range and the later one meet, as the most plausible year, with some room either way.
A second copy of John, P90 from Oxyrhynchus, is also from the second century \cite{intf:liste}.
The other three have nothing so early.
...
The copies of Thomas and Mary are as old as those of Mark and Luke: a Greek Thomas from Oxyrhynchus written not much later than 200AD \cite{grenfell:logia}, and two Greek copies of Mary from the same town, P.Ryl.\ 463 from the early third century and P.Oxy.\ 3525 from the third \cite[pp.~12--13]{deboer:magdalene}.

The references do not move the three any earlier.
The oldest mention of Marcion is Tertullian's, and Tertullian gives credible attestation of Marcion's gospel in 140AD \cite{tertullian:marcionem}.
Mark, Matthew and Luke are first named together by Irenaeus, in about 180AD \cite[3.1.1]{irenaeus:advhaer}.
...
One notice may be older than all of these.
Papias, as Eusebius quotes him, says that Mark wrote down Peter's teaching and that Matthew composed the sayings ``in the Hebrew dialect'' \cite[3.39]{eusebius:he}.
Papias gives no date for himself; his date is inferred from Irenaeus, who calls him a hearer of John and a companion of Polycarp \cite[5.33.4]{irenaeus:advhaer}.
What he meant by the Hebrew dialect is the question.
Origen, Eusebius and Jerome took it as the Hebrew language \cite[3.24.6, 6.25.4]{eusebius:he} \cite[preface]{jerome:matthew}.
This book reads it instead as the Greek spoken by Greeks living in Judea or by Jews living in Greek lands, and makes that case in the discussion of Matthew below.
Either way his notice has no date of its own and reaches us only through Eusebius, so it stays a possible early reference and nothing firmer.
So the order of attestation is John first, by the copies; then Marcion in 140AD; and only in 180AD Mark, Matthew and Luke, named together with the gospels Irenaeus rejects, while the copies of Thomas and Mary are as old as the oldest copies of Mark and Luke.
...
It is a piece of one copy, and a copy is younger than the book it was copied from.
John is a long and finished work, so by the time this copy was made the gospel had been written and carried to Egypt, and was being copied there.
A second witness does not depend on which papyri happened to survive.
Basilides taught at Alexandria \cite[1.24.1]{irenaeus:advhaer}, and Clement of Alexandria places him under Hadrian \cite[7.17]{clement:stromata}.
...
A copy made about 125AD and a quotation under Hadrian point the same way: John was an established book in Egypt in the first decades of the second century.
A book copied in Egypt and cited as the Gospels in Alexandria by then had been in circulation for some time before, so it was most likely established already at the very start of the second century, whatever uncertainty remains about the fragment's exact year.
...
The only possible earlier references to Gospels are Papias \cite[3.39]{eusebius:he}, Polycarp \cite{polycarp:philippians} and Clement \cite{clement:firstclement}, who plausibly wrote before 140AD, and Basilides, whom Clement of Alexandria places under Hadrian and on into the reign of Antoninus \cite[7.17]{clement:stromata}.
Papias's notice, as set out above, may refer to Mark and Matthew, but its date is inferred and its words reach us only through Eusebius.
Basilides quotes John 1:9, which is the evangelist's own sentence and not a saying of Jesus, so his quotation comes from the book itself \cite[7.22]{hippolytus:refutatio}.
