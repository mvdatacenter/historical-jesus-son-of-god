...
\subsection{What is quite striking is that Paul and others write to so many different churches over the short period of time.}\label{par:what-is-quite-striking-is-that-paul-and-others-write-to-so-many-different-churches-over-the-short-period-of-time.}
...
\subsection{Paul’s letters as state correspondence.}\label{par:pauls-letters-as-state-correspondence.}
...
\subsection{Ekklesia — the civic assembly continued}\label{par:ekklesia-the-civic-assembly-continued}
...
\subsection{7a.
Paul fuses army and court: enlistment under the Christ and absorption into his imperial bureaucracy.}\label{par:pau-fuses-army-and-court-enlistment-under-the-christ-and-absorption-into-his-imperial-bureaucracy.}
...
\subsection{A disproof of existing models}\label{par:a-disproof-of-existing-models}
...
\subsection{Bridge: Why Revelation enters the canon now.}\label{par:bridge-why-revelation-enters-the-canon-now}
...
\subsection{Revelation as Imperial Restoration by Revolt from Rome.}\label{par:revelation-as-imperial-restoration-by-revolt-from-rome}
