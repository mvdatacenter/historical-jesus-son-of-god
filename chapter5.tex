...
An Egyptian funerary declaration turns this logic into a condition for survival after death: the speaker says, ``I know the name of that god,'' and this name-knowledge grants access, protection, and life \cite[Spell 17]{bookofthedead}.
...
A solar hymn in the same funerary corpus describes Ra's descent and ascent as the means by which life is given and renewed \cite[Chapter 15]{bookofthedead}.
A funerary declaration makes this descent--ascent logic participatory, as the speaker identifies with Ra as self-produced and shares in the god's movement as the basis of life \cite[Spell 17]{bookofthedead}.
...
Egyptian religion centers on defeating death through eternal life, with funerary texts describing the goal of living forever and judgment before Osiris \cite[Chapter 15]{bookofthedead}\cite[Chapter 125]{bookofthedead}.
...
An Egyptian funerary spell begins with a god who closes, opens, and remains one, and the translation note compares that formula directly with Revelation 1:8 \cite[Spell 17, n.~1]{bookofthedead}.
Atum's decree describes the earth returning to primal water while Atum remains after the present world is undone \cite[Spell 175]{bookofthedead}.
The title therefore functions as more than abstract timelessness: it names the sovereign who outlasts the old world and gives life in the renewed one.
