...
John's theology therefore combines Amun as hidden Father, Ra as visible Son, Logos as Alexandrian mediator, and eternal life as the Egyptian goal now achieved in the present, while Revelation closes the corpus with Atum's beginning-and-end formula spoken from the throne.
...
The scene is usually read through the Greek tale of Leto, who bore Apollo while the serpent Python lay in wait, and the child's ``rod of iron'' quotes Psalm 2:9, so the figure carries Greek and Davidic layers.
Its specific details, however, are Egyptian.
The woman of Revelation 12:1 is clothed with the sun, stands on the moon, and wears a crown of twelve stars, and this is how Isis describes herself in the aretalogy inscribed at Kyme in Asia Minor, the region of the seven churches: ``I showed the paths of the stars; I ordered the course of the sun and the moon'' (IK Kyme 41).
