...
Modern assumptions about an early unified New Testament canon collapse under regional evidence.
Marcion of Pontus attests an Aegean canon centered on Luke and the Pauline Apostolikon by c.~140.
Marcion did not invent this corpus but transmitted the texts already authoritative in Aegean communities.
This proves that Luke and Paul circulated together in the Greek Aegean world before the fourfold gospel.
The Gospel of John shows no literary dependence on Matthew, Mark, or Luke.
John also shows no awareness of Pauline letters, indicating textual independence rather than ignorance.
John emerges from Alexandria as the product of a distinct and self-contained tradition.
The Alexandrian community therefore possessed John prior to any universal canon.
Papias reports that Matthew was written in the Hebrew dialect around c.~120.
This testimony refers to a Judean gospel distinct from the later Greek Matthew.
Matthew thus circulated in Judea and Jerusalem in a separate linguistic and textual form.
Antioch preserves the Markan tradition through Peter's interpreter as its primary gospel.
Each major Christian region therefore maintained its own dominant gospel corpus.
Only with Irenaeus around c.~180 was the fourfold gospel imposed as a universal standard.
