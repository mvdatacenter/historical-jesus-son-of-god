...
Nor does Revelation stop at Atum: its central vision stages Isis, Horus, and Seth.
The scene of the woman, the child, and the dragon in Revelation 12 is usually read through the Greek tale of Leto, who bore Apollo while the serpent Python lay in wait, and the child's ``rod of iron'' quotes Psalm 2:9, so the scene carries Greek and Davidic layers.
Its specific details, however, are Egyptian.
The woman of Revelation 12:1 is γυνὴ περιβεβλημένη τὸν ἥλιον, ``a woman clothed with the sun''---περιβεβλημένη is the ordinary Greek verb for putting on clothing, so she wears the sun as her garment---and she stands on the moon and wears a crown of twelve stars, which is how Isis describes herself in the aretalogy inscribed at Kyme in Asia Minor, the region of the seven churches: ``I showed the paths of the stars; I ordered the course of the sun and the moon'' (IK Kyme 41).
Proclus preserves the fuller text of her veiled-goddess inscription at Sais, which ends ὃν ἐγὼ καρπὸν ἔτεκον ἥλιος ἐγένετο, ``the fruit I brought forth became the sun'' \cite[Book 1, on Timaeus 21e]{proclus:intimaeum}---the mother whose child is the sun.
The dragon of Revelation 12:3 is \emph{pyrros} (πυρρός), ``fiery red,'' and red is Seth's color: Plutarch records that Typhon, whom the Egyptians call Seth, was ``red in complexion'' while Horus was white and Osiris dark, and that only cattle of red color were dedicated to sacrifice \cite[22, 31, 41]{plutarch:deiside}, while the Python of the Greek tale has no color at all.
Apollo defeats the serpent and takes an oracle; the child of Revelation 12:5 is ``caught up to God and to his throne'' and ``will rule all nations''---the path of Horus, who prevails over Seth in battle and is judged the legitimate king by the gods \cite[19]{plutarch:deiside}, receiving the kingship each pharaoh held under the Horus title of his cartouche.
The mother's flight to a place prepared for her (Revelation 12:6) is Isis's road: Plutarch has her go to Horus ``who was being reared in Buto'' beyond Seth's reach, and he even records that Horus was brought up ``by Leto in the marshes round about Buto''---the Greek and Egyptian tellings already fused on Egyptian ground \cite[18, 38]{plutarch:deiside}.
