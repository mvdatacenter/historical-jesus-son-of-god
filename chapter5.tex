...
The tau-rho replicates this exact morphology: a T-cross with the rho's loop forming a ``head,'' visually encoding a crucified figure as life-through-death.
...
The morphology does not change; only the political visibility does.
