...
Plutarch says that some called her ``none other than the Moon'' and explains the horns on her images as the crescent \cite[52]{plutarch:deiside}.
In her aretalogy at Kyme, Isis declares that she showed the paths of the stars and ordered the courses of the sun and moon (I.Kyme 41) \cite{engelmann:kyme}.
Her statues commonly place the solar disk between cow's horns above her head, including the familiar figures of Isis seated with the infant Horus on her lap \cite{met:isis-horus,bm:isis-horus}.
For centuries this had been one of the Mediterranean's most familiar images of a divine mother and child; the same type later reappeared in Christian images of Mary nursing Christ \cite{higgins:divine-mothers}.
The inscription at Sais makes the connection between mother and sun explicit: the goddess whom Plutarch identifies as Isis declares, in the fuller text preserved by Proclus, ``the fruit I brought forth became the sun'' \cite[9]{plutarch:deiside}\cite[Book 1, on Timaeus 21e]{proclus:intimaeum}.
