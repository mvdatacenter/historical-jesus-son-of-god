...
The next Christian cities to appear \emph{after} the New Testament's Greek world arrive together at the close of the second century: Lyons and Vienne in Gaul (177 AD, treated below) and Carthage (c.~180--200 AD, attested in the Scillitan Martyrs and Tertullian).
...
These are the earliest churches the record attests in any of the five absent regions, and they enter it in the same late window as Carthage---the two arrivals close the long Western silence rather than break it early.
And Gaul enters as an eastern outpost rather than a Western exception: the letter's named dead are a native of Pergamum and a Phrygian settled abroad, and every epistle it produces is addressed east, to Asia, Phrygia, and Rome---the same network the authors surveyed above describe, extended one province west.
Spain, Germania, and Britain, the rest of that absent list, have no entry here at all.
