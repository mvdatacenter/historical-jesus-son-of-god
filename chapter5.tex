...
The city secretary, the \emph{grammateus} (γραμματεύς), directs unresolved public business to the \emph{ennomos ekklēsia} (ἔννομος ἐκκλησία)---the lawful assembly---and then dismisses the ἐκκλησία (Acts 19:35, 39--41).
The three occurrences place the word within the ordinary institutions of the Greek city; none refers to a Christian congregation.

Acts 20 keeps the word tied to Ephesus but changes its referent.
