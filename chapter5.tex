...
Luke writes in the polished Greek of the Aegean cities where Paul founded his assemblies.
His preface (Luke 1:1–4) uses historiographic particles such as \textit{epeidēper}, \textit{parēkolouthēkoti}, and \textit{akribōs}, which are characteristic of Aegean historians like Polybius and Dionysius of Halicarnassus.
This elevated register shows that Luke was trained in the rhetorical and historical styles taught in the gymnasia of Macedonia, Achaia, and Asia Minor.
His honorific address \textit{kratistē Theophile} matches civic decrees from these same regions, where titles like \textit{kratistos} appear in inscriptions honoring local officials (IG X.2.1).
Acts 17:6 uses the term \textit{politarchai}, a title verified exclusively in Macedonian inscriptions from Thessalonica, proving that Luke knew local administrative Greek rather than generic literary vocabulary.
The "we-sections" in Acts employ nautical Greek identical to Aegean voyage literature such as the \textit{Periplus}, showing immersion in coastal trading and travel culture.
Luke's periodic syntax, medical vocabulary, and administrative precision match the civic Greek of the Aegean poleis where Paul's letters circulated.
The linguistic evidence aligns Luke with the Greek-educated environment of Macedonia, Achaia, and Asia Minor, where classical historiography and civic administration shaped written prose.
Luke fits the Aegean world because he writes like someone formed inside its elite educational system.
...
The historic claim that Jesus spoke Aramaic rests entirely on the Aramaic phrases in the Gospel of Mark, because no other gospel preserves them independently.
For more than a century scholars treated these seven phrases—\textit{Talitha koum}, \textit{Ephphatha}, \textit{Korban}, \textit{Rabbouni}, \textit{Boanērges}, \textit{Golgotha}, and \textit{Eloi Eloi lama sabachthani}—as literal quotations of Jesus, but this assumption collapses once we identify where Mark was actually writing.
Every Aramaic phrase in Mark matches the western Aramaic dialects of the Syrian–Seleucid belt, not anything associated with Galilee, and this dialectal alignment fits the exact linguistic environment of Antioch: a Greek-speaking metropolitan center surrounded by Aramaic-speaking hinterland.
This Antiochene bilingual world is the only setting in the Eastern Mediterranean where a Greek author would naturally sprinkle Aramaic imperatives, nicknames, and place-names into narrative prose without needing to explain them.
That is why Luke and John never preserve these phrases—because they were not preserving "Jesus's original words"; they were ignoring Mark's regional color.
Once Mark is placed where he belongs—Antioch, not Galilee—the Aramaic in the gospel becomes Mark's language, not Jesus's, and the single pillar supporting the Aramaic-Jesus hypothesis disappears.
The inscriptional profile of Galilee reinforces this conclusion: the surviving early-first-century inscriptions from sites like Sepphoris, Kefar Hananya, Japhia, and Gischala, as well as the coins of Herod Antipas, are Greek, and there is no securely dated Aramaic inscription from any Galilean town associated with Jesus.
This does not drive the argument; it simply confirms that Galilee did not speak with the Aramaic layer reflected in Mark's Syrian dialect.
With Mark's dialect placed in Antioch and Galilee lacking any Aramaic epigraphic footprint, there is no remaining basis for claiming that Jesus taught in Aramaic.
The cumulative evidence points in a single direction: Jesus lived and taught in a region where public language was Greek, and the Aramaic in the tradition comes solely from the Antiochene author of Mark, not from Jesus himself.
