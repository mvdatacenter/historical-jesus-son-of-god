...
John names the creator god the same way.
Atum is the Egyptian god who exists alone before creation and remains as the completed whole when creation ends \cite[Spell 175]{bookofthedead}, and the name means exactly that: the beginning and the end.
John renders this name into Greek as Alpha and Omega (Α and Ω), the first and the last letters of the alphabet standing for the first and the last of all things.
This is the same act of naming that gives the hidden Father the role of Amun and the visible Son the role of Ra: Atum is John's God named in Greek, not a parallel to him.
