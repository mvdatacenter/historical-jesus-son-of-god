...
Jewish apocalyptic literature records the split in exactly these terms: in Daniel's goat vision the great horn breaks and ``for it came up four notable ones toward the four winds of heaven'' (Daniel 8:8), the vision names the goat ``the king of Grecia'' and decodes the horns as ``four kingdoms [that] shall stand up out of the nation'' (Daniel 8:21--22), and Daniel 11:4 repeats the formula for the mighty king whose realm ``shall be broken, and shall be divided toward the four winds of heaven.''
...
Egypt had also long grouped four divine powers around a throne: the four children of Horus stand on the lotus before the enthroned Osiris in the judgment scene, and the older manuscripts title the opening chapter of the Book of the Dead the ``Chapter of coming to the divine Powers attached to Osiris'' \cite[Chapter 1]{bookofthedead}.
These Powers come in paired stations: Horus asks for ``two brothers in Pu and two brothers in Nechen,'' the twin royal cities of Lower and Upper Egypt, ``that they may be with me as an everlasting renewal,'' and the dead must know them station by station---``I know the Powers of Pu: they are Horus, Emsta and Hapi'' \cite[Chapter 112]{bookofthedead}.
Ezekiel's four-faced creature is the oldest surviving literary representation of the Near Eastern fourfold world, combining the four royal symbols, the four cultural blocs, the four winds, the four throne-bearers, and the fourfold cosmic structure.
...
Nor does Victorinus stop at the creatures: the four angels bound at the Euphrates are ``the four corners of the earth which hold the four winds,'' by which ``are meant four nations, because to every nation is sent an angel'' \cite[Rev 9]{victorinus:apocalypse}.
The 1,600 furlongs of blood in Revelation 14:20 he resolves the same way: ``through all the four parts of the world: for there is a quadrate put together by fours, as in four faces and four appearances, and wheels by fours; for forty times four is one thousand six hundred'' \cite[Rev 14]{victorinus:apocalypse}---Ezekiel's four faces and four wheels doing duty as the multiplier of the inhabited world.
