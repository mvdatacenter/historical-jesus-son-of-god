...
\textbf{Revelation} completes this canon pole.
The next section shows that its theological architecture is Egyptian from the throne to the dragon: the one seated on the throne speaks Atum's beginning-and-end formula, and the drama of Revelation 12 casts Isis, Horus, and Seth in its three leading roles.
