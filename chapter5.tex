...
Luke writes in the polished Greek of the Aegean cities that dominate the Pauline correspondence and form the core urban network of early Christianity.
His preface (Luke 1:1–4) uses historiographic particles such as \textit{epeidēper}, \textit{parēkolouthēkoti}, and \textit{akribōs}, the same educated register found in Aegean historians like Polybius and Dionysius of Halicarnassus.
This elevated style reflects the rhetorical training of the gymnasia of Macedonia, Achaia, and Asia Minor—the exact regions addressed in the Pauline letters to Thessalonica, Philippi, Corinth, Ephesus, Colossae, and Galatia.
