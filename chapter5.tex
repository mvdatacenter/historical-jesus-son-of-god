...
The Tacitus passage contains the variant ``Chrestianos'' rather than ``Christianos,'' appears nowhere else in ancient literature for centuries, and describes a group Tacitus himself seems unfamiliar with, writing fifty years after the events.
Pliny the Younger, in his letter to Trajan, similarly indicates he had never participated in trials of Christians and was unsure of proper procedure.
...
Pliny, Tacitus, and the \emph{Acta Scillitanorum} repeatedly accuse Christians of illicit meetings, secret oaths, refusing the imperial cult, and belonging to a \emph{collegium illicitum}.
...
Acts shares notable features with pragmatic Greco-Roman historiography concerned with power, legitimacy, and regime formation, inviting comparison with authors such as Polybius, who writes history to explain how sovereignties rise, stabilize, and confront rivals, rather than Plutarch, who writes moral lives.
...
Egyptian temple religion centered on the god housed in a portable tabernacle, carried on the shoulders of priests, surrounded by a solar halo or radiating frame, revealed before an altar in a moment that made the presence of the deity visible, offered bread, wine, incense, and light, and then returned to the sanctuary once the encounter between god and people had been accomplished.
...
The same pattern appears with particular clarity in the Coptic Procession of the Lamb, where the chosen Eucharistic bread is veiled, marked, lifted by the priest, carried around the altar to chanted responses, and brought into the sanctuary through a veiled threshold that mirrors the architectural progression of Egyptian temples and their hidden inner chambers.
...
\subsection{Egyptian Religion in John}

John removes all competing divine names and uses no proper theonym at all.
There is no YHWH, no El, no Baal, no Zeus, and no named god.
God is named only as Father, Light, the One who sent, and the One who is above.
This matches Egyptian high theology, where the highest god is defined by name-suppression rather than naming.
In Egyptian religion, Amun is the hidden source beyond sight and comprehension.
John states that no one has ever seen God, denying direct access in absolute terms.
This matches Amun exactly as the hidden one, unknowable in essence and never encountered directly.
Second Temple Judaism expects revelation, speech, covenant, and visibility, but John rejects all of these as access paths.
John's Son is light, gives life, enlightens all, comes from above, and returns above.
This is the role of Ra, the visible manifestation of the hidden source and the giver of life through light.
The Father remains unseen, while the Son is seen, known, and encountered, preserving strict source and manifestation roles.
John frames salvation as movement from darkness to light, from ignorance to knowledge, and from blindness to sight.
This is Egyptian and Platonic epistemology, not Jewish eschatology, which centers on obedience and future judgment.
John removes demons, exorcisms, and chaotic nature miracles, clearing away the Phoenician-Syrian spirit-conflict world.
Amun-Ra theology does not depend on territorial spirits or battles but on recognition of the true source and its light.
John asks his readers to recognize the Father they already know through the Light they already understand.

\subsection{Why John Is Not a Jewish Text}

John contains no covenant history and does not rehearse Exodus, Sinai, patriarchs, land promise, or election.
Torah never functions as an authority structure and never adjudicates disputes or grounds Jesus's legitimacy.
``The Jews'' appear as an external opposing group rather than a collective ``we'' or ``Israel.''
God is not introduced as the God of the fathers and is not tied to land, covenant, or ethnic election.
Salvation is defined as knowledge and recognition rather than obedience to commandments.
Judgment is present and epistemic, not future and juridical.
Resurrection is redefined as eternal life now, not a bodily end-times event.
The temple is nullified rather than reformed, with sacred geography abolished.
Scripture operates symbolically and does not compel belief or decide outcomes.
The genre is metaphysical and vertical, not historical, legal, or apocalyptic.
...
\subsection{Luke as Aegean Divine-Man Gospel}

Luke presents Jesus as a public benefactor whose authority is displayed through generous healing, feeding, forgiveness, and mercy.
This follows the Greco-Roman model of the divine man whose virtue is proven by benefaction, not the Judean model of holiness proven by Torah obedience.
Luke consistently frames virtue as visible action toward others rather than fidelity to law.
Unlike Matthew, Luke does not build arguments around Torah fulfillment or sustained legal teaching.
Legal disputes never drive the narrative, and the law simply fades from view as a central concern.
Jerusalem functions as the place of rejection, failure, and death rather than the center of redemption.
Salvation then moves outward across the Aegean world in Acts, reversing the Jerusalem-centered logic of Second Temple Judaism.
Luke writes a Hellenistic divine-man narrative, not a reformist Jewish law gospel.

\subsection{Why Luke Displaces Jewish Religion}

Luke marginalizes the law rather than fulfilling it, and Jesus does not teach Torah intensively.
Legal disputes never organize the narrative or define authority.
Jerusalem functions as the place of rejection, failure, and death rather than redemption.
Salvation then moves outward in Acts away from Jerusalem and Judea.
Israel's leaders are portrayed as structurally blind and consistently hostile to prophets.
Rejection is systemic rather than a series of correctable errors.
Luke does not argue covenant failure or reinterpret election.
He replaces the frame by moving directly to Gentile mission.
The narrative advances without restoring Torah or temple to central roles.

Luke writes in Greek literary forms that belong to the Aegean world, not to Jewish scripture or law.
Luke 1:1--4 uses the standard Greek historiographic preface found in Herodotus, Thucydides, and Polybius, with sources, investigation, order, and patron address.
Acts 27--28 follows Greek epic shipwreck grammar, matching Odyssey-style patterns of peril, divine assurance, survival, island landing, and restoration.
The long speeches in Acts follow Thucydides-style historian practice, where speeches interpret events rather than record verbatim dialogue.
Gregory E. Sterling (2023) classifies Luke--Acts as apologetic historiography written for public defense within Greek historical culture.
John J. Peters (2022) compares Luke systematically with Greek historians and shows that Luke adopts their methods, aims, and narrative tools.
Sean A. Adams argues that Acts functions as collected biography within the Greek prose narrative tradition rather than as Jewish scripture.
These forms dominate Luke's composition from beginning to end and determine how authority, history, and meaning are communicated.
Luke therefore writes from inside Aegean literary culture, not from within Jewish legal, covenantal, or apocalyptic genres.
In Bacchae 434--518, Dionysus is arrested, bound, mocked, and imprisoned, submits without resistance, then escapes effortlessly as the palace collapses and civic control dissolves.
In Acts of the Apostles 16:19--26, Paul and Silas are arrested and imprisoned, offer no resistance, and a sudden physical reversal opens doors and breaks chains.
Both narratives follow the same sequence: lawful arrest, compliant submission, and a material reversal that exposes civic authority as powerless.
This sequence belongs to Dionysiac power grammar, not to generic martyr narrative, where the righteous die rather than nullify confinement.
...
Luke places Lazarus explicitly in Hades rather than Sheol.
Hades is depicted with internal moral geography dividing comfort from torment.
This structure matches Greek conceptions of a differentiated underworld.
The logic corresponds to Homeric and later philosophical Hades approaching Tartarus-like punishment.
No other gospel provides comparable cartography of the afterlife.

Luke assumes immediate placement after death rather than deferred judgment.
...
Paul confirms immediacy by describing death as departure to be with Christ in Philippians.
...
Aristotle defines δικαιοσύνη as correct placement within an ordered system.
...
Polybius treats πίστις as the foundation of political order.
...
\subsection{Mark as Syrian Power Gospel}

Mark presents authority through exorcism, not teaching, making spirit expulsion the first, most frequent, and most public sign of Jesus's power.
In Syrian religion, illness and disorder are caused by invading spirits, and authority is proven by the ability to expel them.
This differs from Judean religion, which centers on Torah obedience, and from Greek religion, which centers on ritual, philosophy, and debate.
In Mark, spirits recognize Jesus immediately, name him correctly, and fear his command.
This matches Syrian possession logic, where spirits instantly recognize superior rank, not Greek daimonology, which involves negotiation and exchange.
Jesus rebukes spirits, storms, and illness directly, without prayer or invocation of another god.
In Baal-world religion, command signals senior divinity, while invocation signals subordination.
Mark shows constant movement across seas, shores, borderlands, and mixed regions such as the Decapolis, Gerasa, and Tyre-Sidon.
Syrian religion is territorial rather than covenantal, with gods ruling zones and spirits infesting regions.
The Gerasene demoniac episode follows Syrian possession rules exactly: many spirits, power through naming, expulsion into animals, and the need for a host.
Mark contains no sustained Torah argument, no legal discourse, and no developed temple theology.
The temple appears mainly as corrupt, doomed, and irrelevant to real authority.
Mark omits genealogy, Moses parallels, Sinai imagery, and fulfillment formulas, leaving power demonstration as the sole proof.
Matthew's later construction of a full Judean framework proves that Mark was not Torah-centric and did not need to be.

\subsection{Why Mark Is Not Written for Torah Followers}

Jesus asserts authority over the Sabbath without arguing Torah interpretation.
Purity laws are abrogated with all foods declared clean, a move Matthew later qualifies.
Scripture appears sparingly and without formula, serving as color rather than authority.
The temple action condemns the institution as a power structure rather than correcting priestly practice.
The passion narrative lacks legal exegesis, covenant logic, or sacrificial explanation.
No genealogy establishes lineage and no Moses parallels structure authority.
There are no Sinai echoes or fulfillment formulas to anchor legitimacy in Torah.
Legal teaching blocks are absent and disputes do not drive the plot.
Authority is demonstrated through power and command rather than scriptural argument.
...
In Seleucid administrative Greek, κύριος is the operative sovereignty term: the king is κύριος of cities, revenues, temples, and peoples.
Seleucid royal letters use formulas like ὁ βασιλεὺς κύριος τῶν πόλεων, ``the king, lord of the cities.''
...
Baal (בעל) is not a proper name but a title meaning ``lord'' or ``master'' in Phoenician and West Semitic usage.
In Greek sources from Syria and Phoenicia, Baal is rendered as κύριος rather than transliterated.
Greek inscriptions from the Syrian coast and hinterland refer to local gods simply as ὁ κύριος, where the underlying deity is Baal.
Calling Jesus κύριος in Syrian space places him directly within the semantic field long occupied by Baal-type lordship.
Mark 4:35--41 presents Jesus as lord of wind and sea through command rather than prayer.
Mark 5:1--20 presents him as lord of spirits in a named territory, completing the Baal power profile.
