...
When the Latin West finally produces a church whose own account survives, that account reads as a Greek-Asian outpost.
The earliest surviving record of Christians in Gaul, the letter of the churches of Lyons and Vienne on the martyrs of 177~AD, survives in Greek and is addressed ``to the brethren throughout Asia and Phrygia'' \cite[5.1]{eusebius:he}.
Its named leaders come from the Greek East on three counts: the bishop Pothinus carries a Greek name, Attalus is ``a native of Pergamos,'' and Alexander is ``a Phrygian by birth'' \cite[5.1]{eusebius:he}.
The congregation was mixed---Roman citizens and Latin names stand among the martyrs, and the public placard at the amphitheater was written ``in the Roman language'' \cite[5.1]{eusebius:he}---yet the community's language, its correspondents, and its leadership all belong to the Greek cities of Asia Minor rather than to Gaul.
