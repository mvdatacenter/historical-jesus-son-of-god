...
The Book of the Dead turns this logic into a condition for survival after death: the speaker says, ``I know the name of that god,'' and this name-knowledge grants access, protection, and life \cite[Spell 17]{bookofthedead}.
...
The Book of the Dead describes Ra rising from the eastern horizon and the deceased coming forth with him into heaven \cite[Chapter 15]{bookofthedead}.
...
A royal ascension utterance in the Pyramid Texts extends the same pattern to the king, who ``ascends to Re' each day'' and descends again, living precisely by joining the god's vertical motion rather than by covenantal obedience \cite[Utterance 627]{pyramidtexts}.
...
Egyptian religion centers on defeating death through eternal life, with the Book of the Dead describing the goal of living forever and judgment before Osiris \cite[Chapter 15]{bookofthedead}\cite[Chapter 125]{bookofthedead}.
Egyptian judgment is triggered by death and conducted after life, where the heart is weighed against Maʿat before Osiris to determine the verdict \cite[Chapter 125]{bookofthedead}.
...
Revelation's Alpha-and-Omega title reaches its fullest form inside the book's restoration frame, where it is glossed as ``the beginning and the end'' and paired with living water (Rev 21:6; 22:13).
The Book of the Dead passage begins with a god who closes, opens, and remains one, and the translation note compares that formula directly with Revelation 1:8 \cite[Spell 17, n.~1]{bookofthedead}.
...
Taken together, three cited details keep the comparison limited to restoration rather than lexical derivation: living water in Revelation, the Book of the Dead note comparing the close-open formula with Revelation 1:8, and Atum remaining after the earth returns to primal water (Rev 21:6; 22:13) \cite[Spell 17, n.~1]{bookofthedead}\cite[Spell 175]{bookofthedead}.
