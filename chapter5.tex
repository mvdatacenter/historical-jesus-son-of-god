...
Coptic writes the god's name as \emph{Atoum} (\coptic{ⲁⲧⲟⲩⲙ}): it opens on \coptic{ⲁ}, alpha itself, and its \coptic{ⲟⲩⲙ} ending carries the omega sound (\coptic{ⲟⲩ} = ō, closed by \coptic{ⲙ}).
Whatever the etymology, for a Greek living in Egypt the resonance was immediate: the two letters side by side would have read as a symbol of Atoum.
The parallel rests on the conjunction of these features---the formula, the water bound to it, and the name that sounds the letters---not on any one alone.
