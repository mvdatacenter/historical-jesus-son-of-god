...
The doubt has a source of its own, and it is the shape of the established account rather than of the evidence.
On the standard reconstruction the Christians of 64 were a small new sect: the standard sociological model of the movement's growth puts it at 1,400 members in the year 50 and 7,530 in the year 100, a hundredth of one percent of the empire, and on that curve Tacitus's ``great multitude'' put to death at Rome has to be called ``much exaggerated,'' since ``even the deaths of several hundred Christians would have been a very serious setback'' \cite[3, 5]{stark:rise}.
A body of that size is not one an emperor picks to carry the blame for the burning of the capital, nor one the Roman crowd could already hate for its crimes, as Tacitus says it did, and the established account has had to work to explain the choice: it inherits Tacitus's own explanation, that Nero needed culprits to kill the rumour that he had ordered the fire \cite[15.44]{tacitus:annals}, and its most recent form gives up the event altogether, reading the passage as genuine Tacitus that ``reflects ideas and connections prevalent at the time the historian was writing and not the realities of the 60s'' \cite{shaw:myth-neronian-persecution}, to which the reply is that the name \emph{Chrestiani} was already in Latin use and a Christian body of some size was in Rome in the 60s, so that Tacitus's report stands \cite{jones:historicity-neronian-persecution}.
The effort is needed only if the Christians of 64 were few and new.
If they were what the preceding chapters found them to be, the party of a royal house from a conquered kingdom, present in the capital in numbers within a generation of its claimant's execution, Nero's choice needs no explaining: a defeated dynasty's following is exactly whom an emperor blames for a catastrophe and exactly whom the crowd already hates.
Pliny's letter then reads the other way from the way it is usually read.
In 112, some fifty years after the executions at Rome, the governor of Bithynia and Pontus writes to Trajan that he has never been present at a trial of Christians and does not know what is punished, or how far, \emph{Cognitionibus de Christianis interfui numquam: ideo nescio quid et quatenus aut puniri soleat aut quaeri}, and his question is whether \emph{nomen ipsum, si flagitiis careat, an flagitia cohaerentia nomini puniantur}, ``the name itself, if free of crimes, or the crimes attached to the name,'' is what is punished \cite[10.96]{pliny:letters}.
His test is a loyalty test, not a test of belief: the accused were released if, repeating after him, they called on the gods, offered wine and incense to the emperor's image, and cursed Christ; the group had stopped its meetings after his edict against political clubs, \emph{hetaeriae}, issued on Trajan's instructions; some of the accused said they had left it three years before, others many years, \emph{non nemo etiam ante viginti}, ``some even twenty years'' before; and those in danger were \emph{multi omnis aetatis, omnis ordinis, utriusque sexus}, ``many, of every age, every rank, and both sexes,'' in the cities, the villages and the countryside alike, so that the temples had been almost deserted, \emph{prope iam desolata templa}, and the flesh of sacrificial victims had found hardly a buyer \cite[10.96]{pliny:letters}.
Trajan's answer is that they are not to be sought out, \emph{conquirendi non sunt}, and that anonymous accusations have no place in any charge \cite[10.97]{pliny:letters}.
Set the two dates side by side.
A new religion of a few thousand would be unknown to the state in 64 and, had it once been the capital's scapegoat, a routine police matter for a governor by 112; the record runs the other way.
In 64 the executions at Rome are carried out as a matter of course, with no one recorded as asking what the crime was; in 112 a governor has to ask Rome whether the name alone still merits death, and Rome answers that it is not to be hunted.
That is the sequence a conquered royal party leaves behind: its followers killed in the capital in the generation of the conquest, while the claimant and his line were a live danger, and fifty years on a provincial governor, facing a movement that had emptied the temples of his province, asking whether the sentence passed on the fathers still binds the grandchildren.
On the standard curve the whole empire held 7,530 Christians in the year 100; Pliny describes one province twelve years later in which the temples had stood almost empty.
Pliny's unfamiliarity is therefore not evidence against the executions of 64; it measures how far from them he stood.
