...
There are very few counterexamples to the four-religion pattern in the New Testament.
One is 2 Peter, which uses Tartarus for fallen angels and mixes Greek underworld language with Jewish angel tradition (2 Pet 2:4).
Another is Mark 13, which introduces apocalyptic material that does not match Mark's power-and-authority grammar.
These two texts are not random exceptions.
2 Peter is widely judged pseudonymous, and Mark 13 is widely judged a post-70 addition.
The breaks align exactly with late or non-original material, which confirms that the authentic texts preserve distinct regional systems.
