...
Egyptian theology defines Ra as the visible manifestation who gives life and light to all, as expressed in the Book of the Dead \cite{bookofthedead}, Chapter 15 (Hymn to Ra).
...
The Book of the Dead turns this logic into a condition for survival after death: in Spell 17 the deceased declares ``I know the name of that god,'' and this name-knowledge grants access, protection, and life \cite{bookofthedead}.
The same structure appears already in the Pyramid Texts \cite{pyramidtexts}, where Utterance 302 states that knowing the divine names enables the king to become an \emph{akh}, a fully effective divine being, directly paralleling John's claim that revealing the Father's name grants \emph{exousia} (ἐξουσία), ``authority,'' to become children of God (John 1:12; 17:6, 17:26).
John frames revelation through descent and ascent of the Son in John 3:13 and John 6:62.
The Book of the Dead \cite{bookofthedead}, Chapter 15, describes Ra's descent and ascent as the means by which life is given and renewed.
...
Pyramid Texts Utterance 306 \cite{pyramidtexts} extends the same pattern to the king, who ascends and descends with Ra and lives precisely by joining the god's vertical motion rather than by covenantal obedience.
