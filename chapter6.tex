...
\subsection{What exactly happen near year 70 AD?}\label{par:what-exactly-happen-near-year-70-ad}

The year 70 AD is very critical in the study of early Christianity.
It the anchor year on which gospels are dated and where Christianity is thought to have altered as a failed apocalyptic movement to a spiritual religion.
We need to ask why exactly year 70 AD is so important.
It was a temple in Jerusalem destroyed by the Romans.
Yet evidently all Christian writers of the time, including Paul, lived far away from Jerusalem and the temple and did not really have a strong connection to it.
While it was certainly an important event, it is not even remotely plausible this event would completely change the theology of Christianity to the point of editing all the gospels, espistles and burning all the original texts.

What we need to realize is that the destruction of the temple in Jerusalem was not the only event that happened in year 70 AD.
There were massive rebellions in the entire Greek world against Roman rule.
Jesephus fought the Romans in Galilee, but there were also massive rebellions in Alexandria Egypt, Antioch Syria, Ephesus Asia Minor, and many other places.
In Alexandria Egypt the rebellion was so severe that the Roman emperor Vespasian had to send his son Titus to crush it.
And notably the rebellion is one where Greeks and Jews fought together in astounding numbers.

And here emerges the critical point.
Josephus, Paul, Peter and James all played on the same team.
They did not follow the same religion, but they all fought for the same cause against the same enemy.
Josephus in his Testimonium Flavianum writes that Jesus was a leader and a figure who got many followers.
In the royal reading this text is not paradoxical at all.
Josephus believed in the religion of Moses, but also wrote about Jesus a Christ, a leader in Galilee.
...
\subsection{The very famous shields with the Chi-Rho symbol were a symbol of the creation of the Eastern Roman Empire.}\label{par:the-very-famous-shields-of-with-the-chi-rho-symbol-were-a-symbol-of-the-creation-of-the-eastern-roman-empire.}
...
\subsection{Victorinus of Pettau (c.~250--303 AD)}\label{par:victorinus-of-pettau-c.-250303-ad}
...
\subsection{Clement of Alexandria's Exhortation to the Greeks (c.~190 AD)}\label{par:clement-of-alexandrias-exhortation-to-the-greeks-c.-190-ad}
