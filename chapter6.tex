...
\subsection{``The Alpha and the Omega'': the Name of the Heliopolitan God}

The throne that announces the new Jerusalem also speaks a name.
Three verses after the holy city descends, the voice declares, ``I am the Alpha and the Omega, the beginning and the end; to the thirsty I will give from the spring of the water of life without payment'' (Rev 21:6).
The verse carries its own gloss: the Alpha and the Omega (Α and Ω) \emph{are} the beginning and the end.
That pairing is the profile of Atum, the self-made god of Heliopolis---the same sun-city to which the phoenix carries its ancestor's bones a few pages above.

Atum is the first god, the self-created one who in the Coffin Texts ``came into being alone'' out of Nun, the primordial abyss, and from whose flesh the gods proceed \cite[Spell 75]{coffintexts}.
He stands at the far end of the cycle as well: in the Book of the Dead he foretells that he will ``deface all'' he has made, so that ``this earth will become water, an inundation as it was in the beginning,'' and that he alone will remain, taking the form of a serpent \cite[Spell 175]{bookofthedead}.
The god of the first water is therefore the god of the last, present when the world rises out of the flood and present when it sinks back into it.
He is, in the plainest Egyptian terms, the beginning and the end, and the water out of which all life first rose is his.

Revelation renders this in Greek.
The self-introduction that opens on beginning-and-end and closes on the water of life is written through the first and last letters of the alphabet: the god whose being spans origin and completion is named as the letter that opens the alphabet and the letter that closes it.
Read beside the Heliopolitan phoenix, the ``Alpha and the Omega'' of the new Jerusalem is not a free-floating figure of divine completeness but the Greek dress of a specific Egyptian god---the self-created lord of the sun-city who is the water of first life and the totality in which the world ends.
...
In his writings, Athanasius articulates the logic of restoration: \emph{De Incarnatione} 54.3 declares that God became man ``so that we might become god'' (θεοποιηθῶμεν), and \emph{Orationes contra Arianos} 2.67--70 extends this into Christ's victory over corruption and death, framing the empire's renewal as participation in divine restoration.
