...
\section{Tertullian (c.~155--240 AD)}\label{sec:tertullian-c.-155240-ad}

Tertullian tells the Roman magistrates exactly what Christians pray for.
In \cite[32]{tertullian:apology} he writes:

\begin{quote}
There is also another and a greater necessity for our offering prayer in behalf of the emperors, nay, for the complete stability of the empire, and for Roman interests in general.
For we know that a mighty shock impending over the whole earth---in fact, the very end of all things threatening dreadful woes---is only retarded by the continued existence of the Roman empire.
...
His description of Christian worship repeats the claim: ``We pray, too, for the emperors, for their ministers and for all in authority, for the welfare of the world, for the prevalence of peace, for the delay of the final consummation'' \cite[39]{tertullian:apology}.
In Tertullian's account the empire is not the enemy of God's plan; it is the structure holding the world together until the plan completes.
His doctrine speaks the same Roman language: Tertullian coined the term \emph{trinitas} in Latin Carthage as the first formal designation of God's threefold identity.
He framed Christian doctrine in categories familiar to Roman pagans accustomed to ranked divine hierarchies.
...
Athanasius states the logic of restoration at the human scale: God was made man ``that we might be made God'' (\emph{theopoiethomen}, θεοποιηθῶμεν) \cite[54.3]{athanasius:deincarnatione}.
\emph{Orationes contra Arianos} 2.67--70 extends this into Christ's victory over corruption and death, which rejoins mortal human nature to God.
What Athanasius restores is not the empire but human nature, and he argues it in Greek metaphysical categories.
The fourth-century dispute over whether the Son is \emph{homoousios} (ὁμοούσιος) or \emph{homoiousios} (ὁμοιούσιος) with the Father is framed entirely in terms of \emph{ousia} (οὐσία), substance or essence.
This category derives from Aristotelian metaphysics and has no equivalent in Hebrew biblical language.
The Nicene Creed depends on Greek philosophical vocabulary for its formulation.
...
The Greek frame was not only literary: Clement organized Christian instruction into catechumens and the \emph{teleioi} (τέλειοι), reserving deeper teaching for the initiated in a pattern drawn from Hellenistic mystery cults.
He states that after the resurrection the Lord transmitted \emph{gnosis} to James, John, and Peter, who passed it to the apostles and then to the Seventy.
