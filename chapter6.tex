...
\subsection{The Sun's Pillar from Heliopolis at the Centre of St Peter's Square}\label{subsec:vatican-obelisk-sun-pillar}

The altar of the sun to which \emph{1 Clement} sends the phoenix has a counterpart in stone, and it stands today at the centre of St Peter's Square.
The obelisk there is the one the emperor Gaius Caligula shipped from Egypt for the circus he built at the foot of the Vatican hill.
Pliny, writing within forty years of the event, lists it as the third obelisk of Rome, ``in the Vatican, in the circus of the emperors Gaius and Nero,'' the only one ever broken in the moving, and names its maker as Nencoreus son of Sesosis \cite[36.74]{pliny:nh}.
He also records the ship, kept for years as the most wonderful thing ever seen on the sea, until Claudius had it brought to Ostia and sunk to found the harbour towers \cite[36.70]{pliny:nh}.
That the stone came with Caligula, stood on the central barrier of his circus, and was moved to the square in 1586 is not a finding of this book; it is the standard account, told in full in the standard history of the obelisks of Rome \cite{iversen:obelisks-in-exile}.

What the stone meant was never in doubt.
Pliny opens his account of obelisks with their purpose: the kings of Egypt cut them ``consecrated to the divinity of the Sun,'' their shape ``the image of its rays,'' and the first was raised, on the command of a dream, by a king ``who reigned in the City of the Sun,'' Heliopolis \cite[36.64]{pliny:nh}.
The Vatican stone carries no hieroglyphs, so its Egyptian history is the one Pliny gives it through its maker.
Nencoreus son of Sesosis, Pliny adds, was the king who ``after blindness, his sight restored, consecrated to the Sun on an oracle's command'' a second obelisk of a hundred cubits \cite[36.74]{pliny:nh}; Herodotus tells the same story of Pheros son of Sesostris, blind for ten years and healed by an oracle, who set up ``in the temple of the Sun'' two obelisks of a single block each, a hundred cubits long \cite[2.111]{herodotus:histories}.
That temple of the Sun is the one to which Herodotus's phoenix carries its father from Arabia \cite[2.73]{herodotus:histories}: the Heliopolis of \emph{1 Clement}, and the city of Atum-Ra whom the reading of John's throne vision in Chapter~5 found behind ``the Alpha and the Omega.''
Rome read the circus obelisk the same way.
Tertullian, describing the circus around 200 AD, explains that ``the circus is consecrated principally to the Sun,'' and that ``the huge obelisk, as Hermateles affirms, is set out for the Sun; its inscription, like its origin,'' \emph{de Aegypto superstitio est}, ``is superstition from Egypt'' \cite[8]{tertullian:spectaculis}.

Rome took the stone from conquered Egypt in two moves.
Under Augustus it stood in Alexandria in the Forum Iulium, raised by Cornelius Gallus, the first prefect of the new province; Gallus's dedication was chiselled away, its bronze letters read again in 1963 from the holes that had held them, and the shaft re-cut to the deified Augustus and to Tiberius, the text still on it today: DIVO CAESARI DIVI F AVGVSTO TI CAESARI DIVI AVGVSTI F AVGVSTO SACRVM \cite{iversen:obelisks-in-exile}.
Caligula then brought it to Rome for his circus \cite[36.74]{pliny:nh}, where it stood on the spina, the central barrier the chariots turned around \cite{iversen:obelisks-in-exile}.
The sun's pillar from Heliopolis, re-dedicated to the deified Caesars, now marked the turning point of the emperor's racecourse.

At the foot of that stone the first Christians of Rome died.
Tacitus records that after the fire of 64 Nero ``put forward as culprits, and punished with the most refined penalties, those whom the crowd, hating them for their crimes, called \emph{Chrestiani}''; that \emph{pereuntibus addita ludibria}, ``mockeries were added to their deaths'': the condemned, ``covered in the skins of beasts, died torn by dogs, or were fixed to crosses, or set alight,'' \emph{atque, ubi defecisset dies, in usum nocturni luminis urerentur}, ``and, when daylight failed, were burned to serve as lamps for the night''; and that ``Nero had offered his own gardens for the spectacle and was giving a circus show, mixing with the crowd in the dress of a charioteer or standing in his chariot'' \cite[15.44]{tacitus:annals}.
The gardens and the circus were on the Vatican: Tacitus has already placed Nero's private chariot ground ``in an enclosed space in the Vatican valley'' \cite[14.14]{tacitus:annals}, and the excavators of the site set the executions in the circus whose spina the obelisk marked \cite{toynbee:shrine-of-st-peter}.
The emperor who staged the show played the Sun: Suetonius reports that Nero ``was held to equal Apollo in song and the Sun in driving a chariot'' \cite[Nero 53]{suetonius:caesars}.
The loyalists of the king crucified under the placard ``King of the Jews'' (Mark 15:26) were burned as lamps beneath the sun's pillar by an emperor in the sun-charioteer's dress.
Chapter~2 read the placard on the cross as Rome's public notice of what it does to a royal claimant; the Vatican show is the same notice a generation on, with the mockery Tacitus names added to it, the claimant's loyalists made into lamps at the foot of what had been their own god's pillar.

Three witnesses put the executions beyond Tacitus alone.
Suetonius, listing Nero's police measures, records that ``punishment was inflicted on the Christians, a class of men of a new and harmful superstition'' \cite[Nero 16]{suetonius:caesars}, and separately that riots had already been put down under Claudius ``at the instigation of Chrestus'' \cite[25.4]{suetonius:claudius}.
\emph{1 Clement}, written at Rome around 96 AD while the stone stood in the circus, names Peter and Paul among the martyrs and beside them ``a great multitude of the elect'' who suffered in the same city \cite[5--6]{clement:firstclement}.
A multitude in the capital within thirty years of the crucifixion is what a royal party with a network across the empire produces, and what a new sect of Galilean villagers could not.

The Christians then made the place theirs.
Peter's grave lies in the cemetery along the north side of the circus: around 200 AD the Roman churchman Gaius could point to ``the trophies of the apostles'' at the Vatican and on the Ostian Way \cite[2.25.7]{eusebius:he}, and the excavations under the basilica in 1940--1949 found the shrine of that date directly beneath the high altar.
That the altar stands over the grave is likewise standard; the excavators' own account is the work to open \cite{toynbee:shrine-of-st-peter}.
In the same cemetery, under the floor of the basilica, the vault of the tomb of the Julii, decorated in the third century, shows Christ as the Sun, a charioteer with the rayed halo of Helios rising among vine tendrils, with Jonah, the fisherman and the shepherd on the walls; the standard catalogue of late antique art describes the figure as Christ ``with a rayed nimbus, like Helios in a quadriga ascending to heaven'' \cite[531--532]{weitzmann:age-of-spirituality}.
The earliest Christian image on the site of St Peter's is the Son as the Sun, which is how Chapter~5 found John's theology cast him, Ra the visible Son of the hidden Father, a few paces from the sun's pillar.
Constantine built the first basilica over the grave, and the obelisk stood beside its south flank for twelve centuries more \cite{iversen:obelisks-in-exile}.

In 1586 Sixtus V had Domenico Fontana move the stone 260 metres to the centre of the new square and cut on its base what the Church took the stone to be and what it made of it \cite{iversen:obelisks-in-exile}.
On the south face: SIXTVS V PONT MAX OBELISCVM VATICANVM DIS GENTIVM IMPIO CVLTV DICATVM AD APOSTOLORVM LIMINA OPEROSO LABORE TRANSTVLIT, ``Sixtus V, supreme pontiff, with laborious effort moved to the threshold of the apostles the Vatican obelisk, dedicated by impious cult to the gods of the nations.''
On the north: CRVCI INVICTAE OBELISCVM VATICANVM AB IMPVRA SVPERSTITIONE EXPIATVM IVSTIVS ET FELICIVS CONSECRAVIT, ``consecrated to the unconquered cross the Vatican obelisk, purged of impure superstition'': Tertullian's word for the stone's Egyptian religion, \emph{superstitio}, is the Church's word fourteen centuries later.
On the west: CHRISTVS VINCIT CHRISTVS REGNAT CHRISTVS IMPERAT, the \emph{Laudes regiae}, the acclamation with which medieval kings and emperors were hailed at their crowning \cite{kantorowicz:laudes-regiae}.
On the east: ECCE CRVX DOMINI FVGITE PARTES ADVERSAE VICIT LEO DE TRIBV IVDA, ``Behold the cross of the Lord; flee, hostile ranks; the Lion of the tribe of Judah has conquered,'' the title of Revelation 5:5, David's line.
The Church knew what it had, a sun pillar from Egypt that the emperors had consecrated to their own deified line, and it chose to centre it, crown it with a cross, and write on it the acclamation of a king and the Lion of Judah.
Rome took the pillar of the Sun from Heliopolis, and the Church took it from Rome: the prayer this book began with is addressed to the Father in the heavens (Section~\ref{subsec:pater-noster}), and the square at the centre of that prayer's church is centred on the Sun's pillar, with a king's acclamation and a dynasty's title cut on its base.
