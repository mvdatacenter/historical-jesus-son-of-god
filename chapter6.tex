...
Refusing the sacrifice while securing the emperor's safety by prayer is not rebellion; it is a bid to replace the imperial cult as the guardian of the empire.
...
The Greek frame was not only literary: Clement organized Christian instruction into catechumens and the \emph{teleioi} (τέλειοι), with the deeper teaching reserved for the higher grade.
...
That is not initiation into a secret; it is a chain of office, authority handed down through ranked grades, the shape of a court rather than a cult.
