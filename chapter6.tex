...
Christian martyr literature picks up exactly this language: the \emph{Martyrdom of Polycarp} 14.2 describes the fire around Polycarp as ``like gold and silver\ldots like the purple of blood'' (τὸ πορφυροῦν αἷμα).
...
And it was precisely at this date when historians put the best estimates for the execution of Paul (c.~64--67 AD), Peter (c.~64--67 AD; Eusebius, \emph{Historia Ecclesiastica} 2.25), and James (c.~62 AD; Josephus, \emph{Antiquities} 20.200).
