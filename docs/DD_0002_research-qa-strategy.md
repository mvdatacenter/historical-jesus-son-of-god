...
- `new_argument` — the chapter does not make this argument. Survives. The finding may use evidence that already appears in the book — that does not matter. What matters is whether the *argument* (the conclusion drawn from the evidence) is new. A finding that looks at the same inscription we cite and draws a different, potentially stronger conclusion is a new argument, not "covered."
