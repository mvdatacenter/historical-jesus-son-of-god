...
- **The manuscript diff contains collaborative prose accepted by the user.** The transcript presents the proposed wording and records acceptance before the chapter edit. This keeps the manuscript as the record of agreed prose.
