...
- **Modern source labels do not stand in for evidence.** Bible verse numbers are acceptable because readers expect that convention, and manuscript shelfmarks may be necessary when identifying a witness. Modern editorial labels for ancient corpora, such as "Book of the Dead Spell 17," usually stay in citations; manuscript prose tells the reader what the source is and what it says unless the label itself is part of the argument.
