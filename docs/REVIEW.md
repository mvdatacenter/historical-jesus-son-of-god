...
- **The manuscript diff satisfies the PR body's current editorial specification.** The body states the passage's role, central claim, required evidence or examples, claim strength, and scope limits. Review each item against the diff so the manuscript does not drift from the agreed purpose while wording is revised.
- **The PR body owns claim calibration and the manuscript reflects it.** The body separates the passage's substantive claims and records the evidence and probability band for each under the README evidence standards. The manuscript expresses each claim naturally at its agreed strength, while the PR body remains the home for bands and editorial assessment and each qualifier applies only to claims at that strength.
...
- **Introductory previews and later detailed treatments perform different jobs.** An introduction may identify a scholarly model and briefly present selected evidence that a later chapter develops fully. Treat the second passage as duplication only when it repeats the same wording, inference, and argumentative work rather than changing the level and purpose of presentation. <!--applies: paths=chapter1.tex-->
