...
Najpełniejszą prezentację tej tezy przedstawiono w \cite{brandon:zealots,brandon:fall}.
Teza ta głosi, że Jezus stał w ciągłości z narodową tradycją zelocką, że jego działanie w Świątyni było aktem rewolucyjnym, a jego uczniowie byli nie tylko słuchaczami, lecz towarzyszami w oporze.
W przeciwieństwie do późniejszych propozycji utożsamiających Jezusa z konkretnymi przywódcami rebelii, wersja ta nie zależała od zrównania go z Judą lub Egipcjaninem, lecz widziała w nim osobną postać ukształtowaną przez te same prądy rewolucyjne.
...
Wątek ten rozwija cały nurt współczesnych opracowań \cite{tabor:dynasty,eisenman:james,maccoby:revolution,thiering:jesusman,jacobovici:tomb,baigent:holyblood}.
