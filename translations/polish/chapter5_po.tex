...
Natomiast w greckojęzycznych miastach, do których pisze Paweł, termin \emph{ekklesia} oraz obserwowane zachowania najściślej odpowiadają praktyce obywatelskiej, co potwierdzają trzy niezależne opracowania \cite{park:ekklesia,esler:galatians,vankooten:ekklesia}, ujmujące wczesne zgromadzenia chrześcijańskie w kontekście trwających instytucji politycznych, a nie jako całkowicie nowe formacje religijne.
...
\textbf{1. Model misyjnej dyfuzji} \cite{harnack:mission,stark:rise}\textbf{.}
...
\textbf{2. Model żydowskiej sekty} \cite{eisenman:james,sanders:jesus,vermes:jesus}\textbf{.}
...
\textbf{3. Model konkurencji kultów imperialnych} \cite{friesen:imperial,harland:associations}\textbf{.}
...
Reprezentatywne głosy: o fundamencie naocznych świadków \cite{bauckham:eyewitnesses}.
O wczesnej, ustalonej czterokrotnej Ewangelii \cite{hengel:fourgospels}.
O wspólnocie Janowej \cite{brown:johannine}.
O miejskich zgromadzeniach Pawłowych \cite{johnson:writings,meeks:urban}.
O wczesnej królewskiej/„dewocyjnej” chrystologii \cite{hurtado:lordjc}.
